...
/**
 * Table class for cargo_copy
 */
class CargoCopy extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->modulo_idmodulo->addMethod("getDefault", fn() => 01);
        ...
        $this->modulo_idmodulo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->intrajornada->Lookup = new Lookup($this->intrajornada, 'cargo_copy', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->tipo_uniforme_idtipo_uniforme->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->funcao_idfuncao->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['funcao_idfuncao'] = &$this->funcao_idfuncao;

        // salario1
        $this->salario1 = new DbField(
            $this, // Table
            'x_salario1', // Variable name
            'salario1', // Name
            '`salario1`', // Expression
            '`salario1`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`salario1`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->salario1->addMethod("getDefault", fn() => 0.00);
        $this->salario1->InputTextType = "text";
        $this->salario1->Raw = true;
        $this->salario1->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->salario1->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['salario1'] = &$this->salario1;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cargo_copy";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->salario1->DbValue = $row['salario1'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CargoCopyList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "CargoCopyView" => $Language->phrase("View"),
            "CargoCopyEdit" => $Language->phrase("Edit"),
            "CargoCopyAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CargoCopyView",
            Config("API_ADD_ACTION") => "CargoCopyAdd",
            Config("API_EDIT_ACTION") => "CargoCopyEdit",
            Config("API_DELETE_ACTION") => "CargoCopyDelete",
            Config("API_LIST_ACTION") => "CargoCopyList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CargoCopyView", $parm);
        } else {
            $url = $this->keyUrl("CargoCopyView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CargoCopyEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CargoCopyList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CargoCopyAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CargoCopyList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CargoCopyDelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->salario1);
                } else {
                    $doc->exportCaption($this->idcargo);
                    $doc->exportCaption($this->cargo);
                    $doc->exportCaption($this->abreviado);
