...
class LocalView extends Local
{
    ...
    // CSS class/style
    public $CurrentPageName = "LocalView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idlocal") ?? Route("idlocal")) !== null) {
            ...
            $this->RecKey["idlocal"] = $this->idlocal->QueryStringValue;
        } elseif (Post("idlocal") !== null) {
            $this->idlocal->setFormValue(Post("idlocal"));
            $this->RecKey["idlocal"] = $this->idlocal->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idlocal->setQueryStringValue($keyValue);
            $this->RecKey["idlocal"] = $this->idlocal->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "LocalList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LocalList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
