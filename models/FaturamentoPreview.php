 ...
 * Page class
 */
class FaturamentoPreview extends Faturamento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaturamentoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "FaturamentoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "cliente") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=cliente&" . GetForeignKeyUrl("fk_idcliente", $this->cliente_idcliente->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "cliente") {
            $this->cliente_idcliente->setQueryStringValue($keys[0] ?? "");
        }
    }
