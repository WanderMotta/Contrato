...
/**
 * Table class for view_efetivo_previsto
 */
class ViewEfetivoPrevisto extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "view_efetivo_previsto";
        $this->TableName = 'view_efetivo_previsto';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "view_efetivo_previsto";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ac_funcao
        $this->ac_funcao = new DbField(
            $this, // Table
            'x_ac_funcao', // Variable name
            'ac_funcao', // Name
            '`ac_funcao`', // Expression
            '`ac_funcao`', // Basic search expression
            200, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`ac_funcao`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->ac_funcao->addMethod("getDefault", fn() => "Nao");
        $this->ac_funcao->InputTextType = "text";
        $this->ac_funcao->Raw = true;
        $this->ac_funcao->Nullable = false; // NOT NULL field
        $this->ac_funcao->Lookup = new Lookup($this->ac_funcao, 'view_efetivo_previsto', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->ac_funcao->OptionCount = 2;
        $this->ac_funcao->SearchOperators = ["=", "<>"];
        $this->Fields['ac_funcao'] = &$this->ac_funcao;
        ...
        $this->intrajornada->Required = true; // Required field
        $this->intrajornada->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_efetivo_previsto";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->ac_funcao->DbValue = $row['ac_funcao'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewEfetivoPrevistoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewEfetivoPrevistoView" => $Language->phrase("View"),
            "ViewEfetivoPrevistoEdit" => $Language->phrase("Edit"),
            "ViewEfetivoPrevistoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewEfetivoPrevistoList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewEfetivoPrevistoView",
            Config("API_ADD_ACTION") => "ViewEfetivoPrevistoAdd",
            Config("API_EDIT_ACTION") => "ViewEfetivoPrevistoEdit",
            Config("API_DELETE_ACTION") => "ViewEfetivoPrevistoDelete",
            Config("API_LIST_ACTION") => "ViewEfetivoPrevistoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewEfetivoPrevistoView", $parm);
        } else {
            $url = $this->keyUrl("ViewEfetivoPrevistoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewEfetivoPrevistoAdd?" . $parm;
        } else {
            $url = "ViewEfetivoPrevistoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewEfetivoPrevistoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewEfetivoPrevistoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewEfetivoPrevistoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewEfetivoPrevistoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewEfetivoPrevistoDelete", $parm);
        }
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->ac_funcao->setDbValue($row['ac_funcao']);
    ...
    {
        global $Response;
        $listPage = "ViewEfetivoPrevistoList";
    ...
    public function renderListRow()
    {
        ...
        // ac_funcao
        if (strval($this->ac_funcao->CurrentValue) != "") {
            $this->ac_funcao->ViewValue = $this->ac_funcao->optionCaption($this->ac_funcao->CurrentValue);
        } else {
            $this->ac_funcao->ViewValue = null;
        }

        // intrajornada
        $this->intrajornada->ViewValue = $this->intrajornada->CurrentValue;
        ...
        // ac_funcao
        $this->ac_funcao->HrefValue = "";
        $this->ac_funcao->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // ac_funcao
        $this->ac_funcao->EditValue = $this->ac_funcao->options(false);
        $this->ac_funcao->PlaceHolder = RemoveHtml($this->ac_funcao->caption());

        // intrajornada
        $this->intrajornada->setupEditAttributes();
        if (!$this->intrajornada->Raw) {
            $this->intrajornada->CurrentValue = HtmlDecode($this->intrajornada->CurrentValue);
        }
        $this->intrajornada->EditValue = $this->intrajornada->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ac_funcao);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ac_funcao);
