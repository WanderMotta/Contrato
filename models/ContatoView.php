 ...
 * Page class
 */
class ContatoView extends Contato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContatoView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContatoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idcontato") ?? Route("idcontato")) !== null) {
            $this->RecKey["idcontato"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idcontato") ?? Route("idcontato")) !== null) {
            ...
            $this->RecKey["idcontato"] = $this->idcontato->QueryStringValue;
        } elseif (Post("idcontato") !== null) {
            $this->idcontato->setFormValue(Post("idcontato"));
            $this->RecKey["idcontato"] = $this->idcontato->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idcontato->setQueryStringValue($keyValue);
            $this->RecKey["idcontato"] = $this->idcontato->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ContatoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ContatoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
