...
/**
 * Table class for mov_insumo_contrato
 */
class MovInsumoContrato extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "mov_insumo_contrato";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idmov_insumo_contrato = new DbField(
            $this, // Table
            'x_idmov_insumo_contrato', // Variable name
            'idmov_insumo_contrato', // Name
            '`idmov_insumo_contrato`', // Expression
            '`idmov_insumo_contrato`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`idmov_insumo_contrato`', // Virtual expression
            false, // Is virtual
        ...
        $this->idmov_insumo_contrato->InputTextType = "text";
        $this->idmov_insumo_contrato->Raw = true;
        $this->idmov_insumo_contrato->IsAutoIncrement = true; // Autoincrement field
        $this->idmov_insumo_contrato->IsPrimaryKey = true; // Primary key field
        $this->idmov_insumo_contrato->Nullable = false; // NOT NULL field
        $this->idmov_insumo_contrato->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idmov_insumo_contrato->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idmov_insumo_contrato'] = &$this->idmov_insumo_contrato;
        ...
        $this->tipo_insumo_idtipo_insumo->Lookup = new Lookup($this->tipo_insumo_idtipo_insumo, 'tipo_insumo', false, 'idtipo_insumo', ["tipo_insumo","","",""], '', '', [], ["x_insumo_idinsumo"], [], [], [], [], false, '', '', "`tipo_insumo`");
        ...
        $this->frequencia->Lookup = new Lookup($this->frequencia, 'mov_insumo_contrato', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "mov_insumo_contrato";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idmov_insumo_contrato->setDbValue($conn->lastInsertId());
            $rs['idmov_insumo_contrato'] = $this->idmov_insumo_contrato->DbValue;
        }
        return $result;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idmov_insumo_contrato']) && !EmptyValue($this->idmov_insumo_contrato->CurrentValue)) {
                $rs['idmov_insumo_contrato'] = $this->idmov_insumo_contrato->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idmov_insumo_contrato', $rs)) {
                AddFilter($where, QuotedName('idmov_insumo_contrato', $this->Dbid) . '=' . QuotedValue($rs['idmov_insumo_contrato'], $this->idmov_insumo_contrato->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idmov_insumo_contrato->DbValue = $row['idmov_insumo_contrato'];
    ...
    {
        return "`idmov_insumo_contrato` = @idmov_insumo_contrato@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->idmov_insumo_contrato->CurrentValue : $this->idmov_insumo_contrato->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idmov_insumo_contrato->CurrentValue = $keys[0];
            } else {
                $this->idmov_insumo_contrato->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('idmov_insumo_contrato', $row) ? $row['idmov_insumo_contrato'] : null;
        } else {
            $val = !EmptyValue($this->idmov_insumo_contrato->OldValue) && !$current ? $this->idmov_insumo_contrato->OldValue : $this->idmov_insumo_contrato->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@idmov_insumo_contrato@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MovInsumoContratoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MovInsumoContratoView" => $Language->phrase("View"),
            "MovInsumoContratoEdit" => $Language->phrase("Edit"),
            "MovInsumoContratoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MovInsumoContratoView",
            Config("API_ADD_ACTION") => "MovInsumoContratoAdd",
            Config("API_EDIT_ACTION") => "MovInsumoContratoEdit",
            Config("API_DELETE_ACTION") => "MovInsumoContratoDelete",
            Config("API_LIST_ACTION") => "MovInsumoContratoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MovInsumoContratoView", $parm);
        } else {
            $url = $this->keyUrl("MovInsumoContratoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MovInsumoContratoAdd?" . $parm;
        } else {
            $url = "MovInsumoContratoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MovInsumoContratoDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"idmov_insumo_contrato\":" . VarToJson($this->idmov_insumo_contrato->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->idmov_insumo_contrato->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->idmov_insumo_contrato->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("idmov_insumo_contrato") ?? Route("idmov_insumo_contrato")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idmov_insumo_contrato->CurrentValue = $key;
            } else {
                $this->idmov_insumo_contrato->OldValue = $key;
            }
    ...
    {
        global $Response;
        $listPage = "MovInsumoContratoList";
    ...
    public function renderListRow()
    {
        ...
        $this->idmov_insumo_contrato->TooltipValue = "";
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idmov_insumo_contrato);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->idmov_insumo_contrato);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->idmov_insumo_contrato, '');
                $doc->exportAggregate($this->dt_cadastro, '');
                $doc->exportAggregate($this->tipo_insumo_idtipo_insumo, '');
                $doc->exportAggregate($this->insumo_idinsumo, 'COUNT');
