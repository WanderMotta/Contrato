...
/**
 * Table class for planilha_custo_contrato
 */
class PlanilhaCustoContrato extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $idplanilha_custo_contrato;
    public $dt_cadastro;
    public $quantidade;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "planilha_custo_contrato";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idplanilha_custo_contrato = new DbField(
            $this, // Table
            'x_idplanilha_custo_contrato', // Variable name
            'idplanilha_custo_contrato', // Name
            '`idplanilha_custo_contrato`', // Expression
            '`idplanilha_custo_contrato`', // Basic search expression
            19, // Type
            4, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`idplanilha_custo_contrato`', // Virtual expression
            false, // Is virtual
        ...
        $this->idplanilha_custo_contrato->InputTextType = "text";
        $this->idplanilha_custo_contrato->Raw = true;
        $this->idplanilha_custo_contrato->IsAutoIncrement = true; // Autoincrement field
        $this->idplanilha_custo_contrato->IsPrimaryKey = true; // Primary key field
        $this->idplanilha_custo_contrato->Nullable = false; // NOT NULL field
        $this->idplanilha_custo_contrato->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idplanilha_custo_contrato->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idplanilha_custo_contrato'] = &$this->idplanilha_custo_contrato;
        ...
        $this->quantidade->DefaultErrorMessage = str_replace(["%1", "%2"], ["1", "10"], $Language->phrase("IncorrectRange"));
        ...
        $this->cargo_idcargo->Lookup = new Lookup($this->cargo_idcargo, 'cargo', false, 'idcargo', ["cargo","salario","",""], '', '', ["x_escala_idescala","x_periodo_idperiodo"], [], ["escala_idescala","periodo_idperiodo"], ["x_escala_idescala","x_periodo_idperiodo"], [], [], false, '`cargo` ASC', '', "CONCAT(COALESCE(`cargo`, ''),'" . ValueSeparator(1, $this->cargo_idcargo) . "',COALESCE(`salario`,''))");
        ...
        $this->acumulo_funcao->Lookup = new Lookup($this->acumulo_funcao, 'planilha_custo_contrato', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // contrato_idcontrato
        $this->contrato_idcontrato = new DbField(
            $this, // Table
            'x_contrato_idcontrato', // Variable name
            'contrato_idcontrato', // Name
            '`contrato_idcontrato`', // Expression
            '`contrato_idcontrato`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`contrato_idcontrato`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->contrato_idcontrato->InputTextType = "text";
        $this->contrato_idcontrato->Raw = true;
        $this->contrato_idcontrato->IsForeignKey = true; // Foreign key field
        $this->contrato_idcontrato->Nullable = false; // NOT NULL field
        $this->contrato_idcontrato->Required = true; // Required field
        $this->contrato_idcontrato->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->contrato_idcontrato->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['contrato_idcontrato'] = &$this->contrato_idcontrato;
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "contrato") {
            ...
            if ($this->contrato_idcontrato->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->idcontrato, $this->contrato_idcontrato->getSessionValue(), $masterTable->idcontrato->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "contrato") {
            $masterTable = Container("contrato");
            if ($this->contrato_idcontrato->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->contrato_idcontrato, $this->contrato_idcontrato->getSessionValue(), $masterTable->idcontrato->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "contrato":
                $key = $keys["contrato_idcontrato"] ?? "";
                if (EmptyValue($key)) {
                    if ($masterTable->idcontrato->Required) { // Required field and empty value
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->idcontrato, $keys["contrato_idcontrato"], $this->contrato_idcontrato->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "contrato":
                return GetKeyFilter($this->contrato_idcontrato, $masterTable->idcontrato->DbValue, $masterTable->idcontrato->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "planilha_custo_contrato";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idplanilha_custo_contrato->setDbValue($conn->lastInsertId());
            $rs['idplanilha_custo_contrato'] = $this->idplanilha_custo_contrato->DbValue;
        }
        return $result;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idplanilha_custo_contrato']) && !EmptyValue($this->idplanilha_custo_contrato->CurrentValue)) {
                $rs['idplanilha_custo_contrato'] = $this->idplanilha_custo_contrato->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idplanilha_custo_contrato', $rs)) {
                AddFilter($where, QuotedName('idplanilha_custo_contrato', $this->Dbid) . '=' . QuotedValue($rs['idplanilha_custo_contrato'], $this->idplanilha_custo_contrato->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idplanilha_custo_contrato->DbValue = $row['idplanilha_custo_contrato'];
        ...
        $this->contrato_idcontrato->DbValue = $row['contrato_idcontrato'];
    }
    ...
    {
        return "`idplanilha_custo_contrato` = @idplanilha_custo_contrato@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->idplanilha_custo_contrato->CurrentValue : $this->idplanilha_custo_contrato->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idplanilha_custo_contrato->CurrentValue = $keys[0];
            } else {
                $this->idplanilha_custo_contrato->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('idplanilha_custo_contrato', $row) ? $row['idplanilha_custo_contrato'] : null;
        } else {
            $val = !EmptyValue($this->idplanilha_custo_contrato->OldValue) && !$current ? $this->idplanilha_custo_contrato->OldValue : $this->idplanilha_custo_contrato->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@idplanilha_custo_contrato@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PlanilhaCustoContratoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PlanilhaCustoContratoView" => $Language->phrase("View"),
            "PlanilhaCustoContratoEdit" => $Language->phrase("Edit"),
            "PlanilhaCustoContratoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PlanilhaCustoContratoList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PlanilhaCustoContratoView",
            Config("API_ADD_ACTION") => "PlanilhaCustoContratoAdd",
            Config("API_EDIT_ACTION") => "PlanilhaCustoContratoEdit",
            Config("API_DELETE_ACTION") => "PlanilhaCustoContratoDelete",
            Config("API_LIST_ACTION") => "PlanilhaCustoContratoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PlanilhaCustoContratoView", $parm);
        } else {
            $url = $this->keyUrl("PlanilhaCustoContratoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PlanilhaCustoContratoAdd?" . $parm;
        } else {
            $url = "PlanilhaCustoContratoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PlanilhaCustoContratoDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "contrato" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_idcontrato", $this->contrato_idcontrato->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        $json = "";
        $json .= "\"idplanilha_custo_contrato\":" . VarToJson($this->idplanilha_custo_contrato->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->idplanilha_custo_contrato->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->idplanilha_custo_contrato->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("idplanilha_custo_contrato") ?? Route("idplanilha_custo_contrato")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idplanilha_custo_contrato->CurrentValue = $key;
            } else {
                $this->idplanilha_custo_contrato->OldValue = $key;
            }
    ...
    {
        global $Response;
        $listPage = "PlanilhaCustoContratoList";
    ...
    public function renderListRow()
    {
        ...
        $this->idplanilha_custo_contrato->TooltipValue = "";
        ...
        $this->contrato_idcontrato->TooltipValue = "";
    ...
    public function aggregateListRowValues()
    {
            ...
            $this->cargo_idcargo->Count++; // Increment count
    }
    ...
    public function aggregateListRow()
    {
            ...
            $this->cargo_idcargo->CurrentValue = $this->cargo_idcargo->Count;
            $this->cargo_idcargo->ViewValue = $this->cargo_idcargo->CurrentValue;
            $this->cargo_idcargo->CssClass = "fw-bold";
            $this->cargo_idcargo->HrefValue = ""; // Clear href value
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idplanilha_custo_contrato);
                    ...
                    $doc->exportCaption($this->contrato_idcontrato);
                } else {
                    $doc->exportCaption($this->idplanilha_custo_contrato);
                    $doc->exportCaption($this->dt_cadastro);
                    $doc->exportCaption($this->quantidade);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->idplanilha_custo_contrato);
                        ...
                        $doc->exportField($this->contrato_idcontrato);
                    } else {
                        $doc->exportField($this->idplanilha_custo_contrato);
                        $doc->exportField($this->dt_cadastro);
                        $doc->exportField($this->quantidade);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->idplanilha_custo_contrato, '');
                ...
                $doc->exportAggregate($this->cargo_idcargo, 'COUNT');
                $doc->exportAggregate($this->acumulo_funcao, '');
                $doc->exportAggregate($this->usuario_idusuario, '');
                $doc->exportAggregate($this->contrato_idcontrato, '');
                $doc->endExportRow();
            }
        }
        if (!$doc->ExportCustom) {
