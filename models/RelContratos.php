...
/**
 * Table class for rel_contratos
 */
class RelContratos extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'view_contratos'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idcontrato->SourceTableVar = 'view_contratos';
        ...
        $this->cliente->Lookup = new Lookup($this->cliente, 'view_contratos', true, 'cliente', ["cliente","","",""], '', '', [], [], [], [], [], [], false, '`cliente` ASC', '', "`cliente`");
        $this->cliente->SearchOperators = ["=", "<>"];
        $this->cliente->SourceTableVar = 'view_contratos';
        ...
        $this->valor->InputTextType = "number";
        $this->valor->Raw = true;
        $this->valor->GroupingFieldId = 2;
        $this->valor->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->valor->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->valor->GroupByType = "";
        $this->valor->GroupInterval = "0";
        $this->valor->GroupSql = "";
        ...
        $this->valor->SourceTableVar = 'view_contratos';
        $this->Fields['valor'] = &$this->valor;

        // insumos
        $this->insumos = new ReportField(
            $this, // Table
            'x_insumos', // Variable name
            'insumos', // Name
            '`insumos`', // Expression
            '`insumos`', // Basic search expression
            131, // Type
            40, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`insumos`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->insumos->addMethod("getDefault", fn() => 0.00);
        $this->insumos->InputTextType = "text";
        $this->insumos->Raw = true;
        $this->insumos->GroupingFieldId = 3;
        $this->insumos->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->insumos->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->insumos->GroupByType = "";
        $this->insumos->GroupInterval = "0";
        $this->insumos->GroupSql = "";
        $this->insumos->Nullable = false; // NOT NULL field
        $this->insumos->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->insumos->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->insumos->SourceTableVar = 'view_contratos';
        $this->Fields['insumos'] = &$this->insumos;
        ...
        $this->quantidade->SourceTableVar = 'view_contratos';
        ...
        $this->cargo->Lookup = new Lookup($this->cargo, 'view_contratos', true, 'cargo', ["cargo","","",""], '', '', [], [], [], [], [], [], false, '`cargo` ASC', '', "`cargo`");
        $this->cargo->SearchOperators = ["=", "<>"];
        $this->cargo->SourceTableVar = 'view_contratos';
        $this->cargo->SearchType = "dropdown";
        $this->Fields['cargo'] = &$this->cargo;

        // salario
        $this->salario = new ReportField(
            $this, // Table
        ...
        $this->salario->SourceTableVar = 'view_contratos';
        ...
        $this->acumulo_funcao->Lookup = new Lookup($this->acumulo_funcao, 'rel_contratos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->acumulo_funcao->OptionCount = 2;
        $this->acumulo_funcao->SearchOperators = ["=", "<>"];
        $this->acumulo_funcao->SourceTableVar = 'view_contratos';
        ...
        $this->escala->UseFilter = true; // Table header filter
        $this->escala->Lookup = new Lookup($this->escala, 'rel_contratos', true, 'escala', ["escala","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->escala->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->escala->SourceTableVar = 'view_contratos';
        $this->escala->SearchType = "dropdown";
        ...
        $this->periodo->SourceTableVar = 'view_contratos';
        $this->Fields['periodo'] = &$this->periodo;

        // jornada
        $this->jornada = new ReportField(
            $this, // Table
        ...
        $this->jornada->SourceTableVar = 'view_contratos';
        ...
        $this->intrajornada_tipo->Nullable = false; // NOT NULL field
        $this->intrajornada_tipo->Required = true; // Required field
        $this->intrajornada_tipo->UseFilter = true; // Table header filter
        $this->intrajornada_tipo->Lookup = new Lookup($this->intrajornada_tipo, 'rel_contratos', true, 'intrajornada_tipo', ["intrajornada_tipo","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->intrajornada_tipo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->intrajornada_tipo->SourceTableVar = 'view_contratos';
        $this->intrajornada_tipo->SearchType = "dropdown";
        $this->Fields['intrajornada_tipo'] = &$this->intrajornada_tipo;

        // ativo
        $this->ativo = new ReportField(
            $this, // Table
        ...
        $this->ativo->Lookup = new Lookup($this->ativo, 'rel_contratos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->ativo->OptionCount = 2;
        $this->ativo->SearchOperators = ["=", "<>"];
        $this->ativo->SourceTableVar = 'view_contratos';
        $this->Fields['ativo'] = &$this->ativo;

        // cnpj
        $this->cnpj = new ReportField(
            $this, // Table
        ...
        $this->cnpj->SourceTableVar = 'view_contratos';
        $this->Fields['cnpj'] = &$this->cnpj;

        // contato
        $this->contato = new ReportField(
            $this, // Table
        ...
        $this->contato->SourceTableVar = 'view_contratos';
        ...
        $this->_email->SourceTableVar = 'view_contratos';
        $this->Fields['email'] = &$this->_email;

        // telefone
        $this->telefone = new ReportField(
            $this, // Table
        ...
        $this->telefone->SourceTableVar = 'view_contratos';
        $this->Fields['telefone'] = &$this->telefone;

        // endereco
        $this->endereco = new ReportField(
            $this, // Table
        ...
        $this->endereco->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->endereco->SourceTableVar = 'view_contratos';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_contratos";
    }
    ...
    public function getSqlSelect()
    {
        ...
        $groupField = &$this->valor;
        if ($groupField->GroupSql != "") {
            $expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
            $select->addSelect($expr);
        }
        $groupField = &$this->insumos;
        if ($groupField->GroupSql != "") {
            $expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
            $select->addSelect($expr);
        }
