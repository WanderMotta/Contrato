 ...
 * Page class
 */
class PeriodoView extends Periodo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeriodoView";
    ...
    // CSS class/style
    public $CurrentPageName = "PeriodoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idperiodo") ?? Route("idperiodo")) !== null) {
            $this->RecKey["idperiodo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idperiodo") ?? Route("idperiodo")) !== null) {
            ...
            $this->RecKey["idperiodo"] = $this->idperiodo->QueryStringValue;
        } elseif (Post("idperiodo") !== null) {
            $this->idperiodo->setFormValue(Post("idperiodo"));
            $this->RecKey["idperiodo"] = $this->idperiodo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idperiodo->setQueryStringValue($keyValue);
            $this->RecKey["idperiodo"] = $this->idperiodo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PeriodoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PeriodoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
