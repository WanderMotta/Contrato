 ...
 * Page class
 */
class BeneficiosDelete extends Beneficios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BeneficiosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "BeneficiosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BeneficiosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("BeneficiosList"); // Return to list
                return;
            }
        }
