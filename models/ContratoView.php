...
class ContratoView extends Contrato
{
    ...
    // CSS class/style
    public $CurrentPageName = "ContratoView";
    ...
    public function setVisibility()
    {
        ...
        $this->valor_antes->setVisibility();
    }
    ...
    public function __construct()
    {
        ...
        // Set up record key
        if (($keyValue = Get("idcontrato") ?? Route("idcontrato")) !== null) {
            $this->RecKey["idcontrato"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $matchRecord = false;
        if (($keyValue = Get("idcontrato") ?? Route("idcontrato")) !== null) {
            $this->idcontrato->setQueryStringValue($keyValue);
            $this->RecKey["idcontrato"] = $this->idcontrato->QueryStringValue;
        } elseif (Post("idcontrato") !== null) {
            $this->idcontrato->setFormValue(Post("idcontrato"));
            $this->RecKey["idcontrato"] = $this->idcontrato->FormValue;
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_planilha_custo_contrato");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("planilha_custo_contrato", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PlanilhaCustoContratoList?" . Config("TABLE_SHOW_MASTER") . "=contrato&" . GetForeignKeyUrl("fk_idcontrato", $this->idcontrato->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("PlanilhaCustoContratoGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'contrato')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=planilha_custo_contrato"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
            $detailViewTblVar .= "planilha_custo_contrato";
        }
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'contrato')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=planilha_custo_contrato"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
            $detailEditTblVar .= "planilha_custo_contrato";
        }
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'contrato')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=planilha_custo_contrato"))) . "\">" . $Language->phrase("MasterDetailCopyLink", null) . "</a></li>";
            if ($detailCopyTblVar != "") {
                $detailCopyTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_mov_insumo_contrato");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("mov_insumo_contrato", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("MovInsumoContratoList?" . Config("TABLE_SHOW_MASTER") . "=contrato&" . GetForeignKeyUrl("fk_idcontrato", $this->idcontrato->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("MovInsumoContratoGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'contrato')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=mov_insumo_contrato"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'contrato')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=mov_insumo_contrato"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'contrato')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=mov_insumo_contrato"))) . "\">" . $Language->phrase("MasterDetailCopyLink", null) . "</a></li>";
            if ($detailCopyTblVar != "") {
                $detailCopyTblVar .= ",";
            }
    ...
    protected function setupDetailParms()
    {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("planilha_custo_contrato", $detailTblVar)) {
                $detailPageObj = Container("PlanilhaCustoContratoGrid");
                if ($detailPageObj->DetailView) {
                    ...
                    $detailPageObj->contrato_idcontrato->IsDetailKey = true;
                    $detailPageObj->contrato_idcontrato->CurrentValue = $this->idcontrato->CurrentValue;
                    $detailPageObj->contrato_idcontrato->setSessionValue($detailPageObj->contrato_idcontrato->CurrentValue);
                }
            }
            if (in_array("mov_insumo_contrato", $detailTblVar)) {
                $detailPageObj = Container("MovInsumoContratoGrid");
                if ($detailPageObj->DetailView) {
                    $detailPageObj->EventCancelled = $this->EventCancelled;
                    $detailPageObj->CurrentMode = "view";
