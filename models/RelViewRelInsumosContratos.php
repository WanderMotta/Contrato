...
/**
 * Table class for rel_view_rel_insumos_contratos
 */
class RelViewRelInsumosContratos extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "rel_view_rel_insumos_contratos";
        $this->TableName = 'rel_view_rel_insumos_contratos';
        $this->TableType = "REPORT";
        $this->TableReportType = "summary"; // Report Type
        $this->ReportSourceTable = 'view_rel_insumos_contratos'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->cliente->Lookup = new Lookup($this->cliente, 'view_rel_insumos_contratos', true, 'cliente', ["cliente","","",""], '', '', [], [], [], [], [], [], false, '`cliente` ASC', '', "`cliente`");
        $this->cliente->SearchOperators = ["=", "<>"];
        $this->cliente->SourceTableVar = 'view_rel_insumos_contratos';
        ...
        $this->insumo->setSelectMultiple(false); // Select one
        $this->insumo->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->insumo->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->insumo->Lookup = new Lookup($this->insumo, 'view_rel_insumos_contratos', true, 'insumo', ["insumo","","",""], '', '', [], [], [], [], [], [], false, '`insumo` ASC', '', "`insumo`");
        $this->insumo->SearchOperators = ["=", "<>"];
        $this->insumo->SourceTableVar = 'view_rel_insumos_contratos';
        $this->insumo->SearchType = "dropdown";
        ...
        $this->frequencia->SourceTableVar = 'view_rel_insumos_contratos';
        ...
        $this->qtde->SourceTableVar = 'view_rel_insumos_contratos';
        $this->Fields['qtde'] = &$this->qtde;

        // Vr Mensal
        $this->VrMensal = new ReportField(
            $this, // Table
        ...
        $this->VrMensal->SourceTableVar = 'view_rel_insumos_contratos';
        $this->Fields['Vr Mensal'] = &$this->VrMensal;

        // Vr Total
        $this->VrTotal = new ReportField(
            $this, // Table
        ...
        $this->VrTotal->SourceTableVar = 'view_rel_insumos_contratos';
        ...
        $this->tipo_insumo->Lookup = new Lookup($this->tipo_insumo, 'view_rel_insumos_contratos', true, 'tipo_insumo', ["tipo_insumo","","",""], '', '', [], [], [], [], [], [], false, '`tipo_insumo` ASC', '', "`tipo_insumo`");
        $this->tipo_insumo->SearchOperators = ["=", "<>"];
        $this->tipo_insumo->SourceTableVar = 'view_rel_insumos_contratos';
        ...
        $this->idcontrato->SourceTableVar = 'view_rel_insumos_contratos';
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("SUM(`Vr Total`) AS sum_vrtotal");
    }
    ...
    public function renderLookup()
    {
        ...
        $this->insumo->ViewValue = GetDropDownDisplayValue($this->insumo->CurrentValue, "", 0);
    ...
    {
        return "RelViewRelInsumosContratos";
    }

    // API page name
    public function getApiPageName($action)
    {
        return "RelViewRelInsumosContratosSummary";
    }
