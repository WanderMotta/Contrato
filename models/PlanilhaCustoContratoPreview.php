 ...
 * Page class
 */
class PlanilhaCustoContratoPreview extends PlanilhaCustoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoContratoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoContratoPreview";
