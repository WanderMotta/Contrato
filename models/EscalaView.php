 ...
 * Page class
 */
class EscalaView extends Escala
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "EscalaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idescala") ?? Route("idescala")) !== null) {
            ...
            $this->RecKey["idescala"] = $this->idescala->QueryStringValue;
        } elseif (Post("idescala") !== null) {
            $this->idescala->setFormValue(Post("idescala"));
            $this->RecKey["idescala"] = $this->idescala->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idescala->setQueryStringValue($keyValue);
            $this->RecKey["idescala"] = $this->idescala->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "EscalaList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EscalaList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
