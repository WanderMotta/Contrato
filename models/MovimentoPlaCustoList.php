 ...
 * Page class
 */
class MovimentoPlaCustoList extends MovimentoPlaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimentoPlaCustoList";
    ...
    public $FormName = "fmovimento_pla_custolist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "MovimentoPlaCustoList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "MovimentoPlaCustoDelete";
        $this->MultiUpdateUrl = "MovimentoPlaCustoUpdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->idmovimento_pla_custo->AdvancedSearch->toJson(), ","); // Field idmovimento_pla_custo
        $filterList = Concat($filterList, $this->planilha_custo_idplanilha_custo->AdvancedSearch->toJson(), ","); // Field planilha_custo_idplanilha_custo
        ...
        $filterList = Concat($filterList, $this->itens_modulo_iditens_modulo->AdvancedSearch->toJson(), ","); // Field itens_modulo_iditens_modulo
        ...
        $filterList = Concat($filterList, $this->calculo_idcalculo->AdvancedSearch->toJson(), ","); // Field calculo_idcalculo
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fmovimento_pla_custosrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idmovimento_pla_custo
        $this->idmovimento_pla_custo->AdvancedSearch->SearchValue = @$filter["x_idmovimento_pla_custo"];
        $this->idmovimento_pla_custo->AdvancedSearch->SearchOperator = @$filter["z_idmovimento_pla_custo"];
        $this->idmovimento_pla_custo->AdvancedSearch->SearchCondition = @$filter["v_idmovimento_pla_custo"];
        $this->idmovimento_pla_custo->AdvancedSearch->SearchValue2 = @$filter["y_idmovimento_pla_custo"];
        $this->idmovimento_pla_custo->AdvancedSearch->SearchOperator2 = @$filter["w_idmovimento_pla_custo"];
        $this->idmovimento_pla_custo->AdvancedSearch->save();

        // Field planilha_custo_idplanilha_custo
        $this->planilha_custo_idplanilha_custo->AdvancedSearch->SearchValue = @$filter["x_planilha_custo_idplanilha_custo"];
        $this->planilha_custo_idplanilha_custo->AdvancedSearch->SearchOperator = @$filter["z_planilha_custo_idplanilha_custo"];
        $this->planilha_custo_idplanilha_custo->AdvancedSearch->SearchCondition = @$filter["v_planilha_custo_idplanilha_custo"];
        $this->planilha_custo_idplanilha_custo->AdvancedSearch->SearchValue2 = @$filter["y_planilha_custo_idplanilha_custo"];
        $this->planilha_custo_idplanilha_custo->AdvancedSearch->SearchOperator2 = @$filter["w_planilha_custo_idplanilha_custo"];
        $this->planilha_custo_idplanilha_custo->AdvancedSearch->save();
        ...
        // Field itens_modulo_iditens_modulo
        $this->itens_modulo_iditens_modulo->AdvancedSearch->SearchValue = @$filter["x_itens_modulo_iditens_modulo"];
        $this->itens_modulo_iditens_modulo->AdvancedSearch->SearchOperator = @$filter["z_itens_modulo_iditens_modulo"];
        $this->itens_modulo_iditens_modulo->AdvancedSearch->SearchCondition = @$filter["v_itens_modulo_iditens_modulo"];
        $this->itens_modulo_iditens_modulo->AdvancedSearch->SearchValue2 = @$filter["y_itens_modulo_iditens_modulo"];
        $this->itens_modulo_iditens_modulo->AdvancedSearch->SearchOperator2 = @$filter["w_itens_modulo_iditens_modulo"];
        $this->itens_modulo_iditens_modulo->AdvancedSearch->save();
        ...
        // Field calculo_idcalculo
        $this->calculo_idcalculo->AdvancedSearch->SearchValue = @$filter["x_calculo_idcalculo"];
        $this->calculo_idcalculo->AdvancedSearch->SearchOperator = @$filter["z_calculo_idcalculo"];
        $this->calculo_idcalculo->AdvancedSearch->SearchCondition = @$filter["v_calculo_idcalculo"];
        $this->calculo_idcalculo->AdvancedSearch->SearchValue2 = @$filter["y_calculo_idcalculo"];
        $this->calculo_idcalculo->AdvancedSearch->SearchOperator2 = @$filter["w_calculo_idcalculo"];
        $this->calculo_idcalculo->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->planilha_custo_idplanilha_custo, $ctrl); // planilha_custo_idplanilha_custo
            $this->updateSort($this->modulo_idmodulo, $ctrl); // modulo_idmodulo
            $this->updateSort($this->itens_modulo_iditens_modulo, $ctrl); // itens_modulo_iditens_modulo
            $this->updateSort($this->porcentagem, $ctrl); // porcentagem
            $this->updateSort($this->valor, $ctrl); // valor
            $this->updateSort($this->obs, $ctrl); // obs
            $this->updateSort($this->calculo_idcalculo, $ctrl); // calculo_idcalculo
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->idmovimento_pla_custo->setSort("");
                $this->planilha_custo_idplanilha_custo->setSort("");
                $this->dt_cadastro->setSort("");
                $this->modulo_idmodulo->setSort("");
                $this->itens_modulo_iditens_modulo->setSort("");
                $this->porcentagem->setSort("");
                $this->valor->setSort("");
                $this->obs->setSort("");
                $this->calculo_idcalculo->setSort("");
            }
    ...
    public function renderListOptions()
    {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmovimento_pla_custolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmovimento_pla_custolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->idmovimento_pla_custo->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "planilha_custo_idplanilha_custo");
            $this->createColumnOption($option, "modulo_idmodulo");
            $this->createColumnOption($option, "itens_modulo_iditens_modulo");
            $this->createColumnOption($option, "porcentagem");
            $this->createColumnOption($option, "valor");
            $this->createColumnOption($option, "obs");
            $this->createColumnOption($option, "calculo_idcalculo");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmovimento_pla_custosrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmovimento_pla_custosrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmovimento_pla_custolist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fmovimento_pla_custolist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmovimento_pla_custosrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "planilha_custo") {
            $planilha_custo = new PlanilhaCustoList();
            $rsmaster = $planilha_custo->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($planilha_custo);
                    $planilha_custo->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
        ...
        // Export master record
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "calculo") {
            $calculo = new CalculoList();
            $rsmaster = $calculo->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($calculo);
                    $calculo->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
                $doc->setStyle($exportStyle); // Restore
