 ...
 * Page class
 */
class UniformeCargoPreview extends UniformeCargo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UniformeCargoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "UniformeCargoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "tipo_uniforme") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=tipo_uniforme&" . GetForeignKeyUrl("fk_idtipo_uniforme", $this->tipo_uniforme_idtipo_uniforme->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "tipo_uniforme") {
            $this->tipo_uniforme_idtipo_uniforme->setQueryStringValue($keys[0] ?? "");
        }
    }
