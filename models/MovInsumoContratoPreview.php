 ...
 * Page class
 */
class MovInsumoContratoPreview extends MovInsumoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoContratoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoContratoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "contrato") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=contrato&" . GetForeignKeyUrl("fk_idcontrato", $this->contrato_idcontrato->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "contrato") {
            $this->contrato_idcontrato->setQueryStringValue($keys[0] ?? "");
        }
    }
