 ...
 * Page class
 */
class PropostaDelete extends Proposta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PropostaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PropostaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PropostaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PropostaList"); // Return to list
                return;
            }
        }
