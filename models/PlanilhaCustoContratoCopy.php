...
/**
 * Table class for planilha_custo_contrato_copy
 */
class PlanilhaCustoContratoCopy extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "planilha_custo_contrato_copy";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->acumulo_funcao->Lookup = new Lookup($this->acumulo_funcao, 'planilha_custo_contrato_copy', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->tipo_intrajornada_idtipo_intrajornada->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->usuario_idusuario->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "planilha_custo_contrato_copy";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PlanilhaCustoContratoCopyList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PlanilhaCustoContratoCopyView" => $Language->phrase("View"),
            "PlanilhaCustoContratoCopyEdit" => $Language->phrase("Edit"),
            "PlanilhaCustoContratoCopyAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PlanilhaCustoContratoCopyList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PlanilhaCustoContratoCopyView",
            Config("API_ADD_ACTION") => "PlanilhaCustoContratoCopyAdd",
            Config("API_EDIT_ACTION") => "PlanilhaCustoContratoCopyEdit",
            Config("API_DELETE_ACTION") => "PlanilhaCustoContratoCopyDelete",
            Config("API_LIST_ACTION") => "PlanilhaCustoContratoCopyList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PlanilhaCustoContratoCopyView", $parm);
        } else {
            $url = $this->keyUrl("PlanilhaCustoContratoCopyView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PlanilhaCustoContratoCopyAdd?" . $parm;
        } else {
            $url = "PlanilhaCustoContratoCopyAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoCopyEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoCopyList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoCopyAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanilhaCustoContratoCopyList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PlanilhaCustoContratoCopyDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PlanilhaCustoContratoCopyList";
