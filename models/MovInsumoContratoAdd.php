 ...
 * Page class
 */
class MovInsumoContratoAdd extends MovInsumoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoContratoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoContratoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MovInsumoContratoView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        $detailKeys = [];
        $detailKeys["contrato_idcontrato"] = $this->contrato_idcontrato->CurrentValue;
