 ...
 * Page class
 */
class MovimentoPlaCustoDelete extends MovimentoPlaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimentoPlaCustoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimentoPlaCustoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MovimentoPlaCustoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MovimentoPlaCustoList"); // Return to list
                return;
            }
        }
