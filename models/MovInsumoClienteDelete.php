 ...
 * Page class
 */
class MovInsumoClienteDelete extends MovInsumoCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoClienteDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoClienteDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MovInsumoClienteList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MovInsumoClienteList"); // Return to list
                return;
            }
        }
