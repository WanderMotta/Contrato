 ...
 * Page class
 */
class ItensModuloEdit extends ItensModulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItensModuloEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ItensModuloEdit";
    ...
    {
        $this->iditens_modulo->setVisibility();
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("iditens_modulo") ?? Key(0) ?? Route(2)) !== null) {
                $this->iditens_modulo->setQueryStringValue($keyValue);
                $this->iditens_modulo->setOldValue($this->iditens_modulo->QueryStringValue);
            } elseif (Post("iditens_modulo") !== null) {
                $this->iditens_modulo->setFormValue(Post("iditens_modulo"));
                $this->iditens_modulo->setOldValue($this->iditens_modulo->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("iditens_modulo") ?? Route("iditens_modulo")) !== null) {
                    ...
                    $this->iditens_modulo->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->iditens_modulo->IsDetailKey) {
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->iditens_modulo->Visible && $this->iditens_modulo->Required) {
                if (!$this->iditens_modulo->IsDetailKey && EmptyValue($this->iditens_modulo->FormValue)) {
                    $this->iditens_modulo->addErrorMessage(str_replace("%s", $this->iditens_modulo->caption(), $this->iditens_modulo->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // modulo_idmodulo
        if ($this->modulo_idmodulo->getSessionValue() != "") {
            $this->modulo_idmodulo->ReadOnly = true;
        }
