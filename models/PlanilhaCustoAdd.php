 ...
 * Page class
 */
class PlanilhaCustoAdd extends PlanilhaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PlanilhaCustoView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            if (in_array("movimento_pla_custo", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->planilha_custo_idplanilha_custo->setSessionValue($this->idplanilha_custo->CurrentValue); // Set master key
                $Security->loadCurrentUserLevel($this->ProjectID . "movimento_pla_custo"); // Load user level of detail table
                $addRow = $detailPage->gridInsert();
                $Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
                if (!$addRow) {
                $detailPage->planilha_custo_idplanilha_custo->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
