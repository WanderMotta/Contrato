...
/**
 * Table class for view_contratos
 */
class ViewContratos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_contratos";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->ativo->Lookup = new Lookup($this->ativo, 'view_contratos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->acumulo_funcao->Lookup = new Lookup($this->acumulo_funcao, 'view_contratos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->insumos->DbValue = $row['insumos'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewContratosList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewContratosView" => $Language->phrase("View"),
            "ViewContratosEdit" => $Language->phrase("Edit"),
            "ViewContratosAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewContratosView",
            Config("API_ADD_ACTION") => "ViewContratosAdd",
            Config("API_EDIT_ACTION") => "ViewContratosEdit",
            Config("API_DELETE_ACTION") => "ViewContratosDelete",
            Config("API_LIST_ACTION") => "ViewContratosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewContratosView", $parm);
        } else {
            $url = $this->keyUrl("ViewContratosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewContratosAdd?" . $parm;
        } else {
            $url = "ViewContratosAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewContratosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewContratosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewContratosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewContratosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewContratosDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // insumos
        $this->insumos->setupEditAttributes();
        $this->insumos->EditValue = $this->insumos->CurrentValue;
        $this->insumos->PlaceHolder = RemoveHtml($this->insumos->caption());
        if (strval($this->insumos->EditValue) != "" && is_numeric($this->insumos->EditValue)) {
            $this->insumos->EditValue = FormatNumber($this->insumos->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->insumos);
