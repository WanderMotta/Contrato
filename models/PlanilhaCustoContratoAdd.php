 ...
 * Page class
 */
class PlanilhaCustoContratoAdd extends PlanilhaCustoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoContratoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoContratoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PlanilhaCustoContratoView") {
