 ...
 * Page class
 */
class FaturamentoDelete extends Faturamento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaturamentoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "FaturamentoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FaturamentoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("FaturamentoList"); // Return to list
                return;
            }
        }
