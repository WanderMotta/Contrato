 ...
 * Page class
 */
class MovInsumoClientePreview extends MovInsumoCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoClientePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoClientePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "proposta") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=proposta&" . GetForeignKeyUrl("fk_idproposta", $this->proposta_idproposta->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "proposta") {
            $this->proposta_idproposta->setQueryStringValue($keys[0] ?? "");
        }
    }
