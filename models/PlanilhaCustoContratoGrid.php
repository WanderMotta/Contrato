 ...
 * Page class
 */
class PlanilhaCustoContratoGrid extends PlanilhaCustoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoContratoGrid";
    ...
    public $FormName = "fplanilha_custo_contratogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoContratoGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idplanilha_custo_contrato->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idplanilha_custo_contrato->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'planilha_custo_contrato'
