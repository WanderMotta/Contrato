...
/**
 * Table class for dissidio
 */
class Dissidio extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->idcargo->Required = true; // Required field
        ...
        // salario_atual
        $this->salario_atual = new DbField(
            $this, // Table
            'x_salario_atual', // Variable name
            'salario_atual', // Name
            '`salario_atual`', // Expression
            '`salario_atual`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`salario_atual`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->salario_atual->InputTextType = "text";
        $this->salario_atual->Raw = true;
        $this->salario_atual->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->salario_atual->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['salario_atual'] = &$this->salario_atual;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "dissidio";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->salario_atual->DbValue = $row['salario_atual'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DissidioList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DissidioView" => $Language->phrase("View"),
            "DissidioEdit" => $Language->phrase("Edit"),
            "DissidioAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DissidioView",
            Config("API_ADD_ACTION") => "DissidioAdd",
            Config("API_EDIT_ACTION") => "DissidioEdit",
            Config("API_DELETE_ACTION") => "DissidioDelete",
            Config("API_LIST_ACTION") => "DissidioList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DissidioView", $parm);
        } else {
            $url = $this->keyUrl("DissidioView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DissidioEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DissidioList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DissidioAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DissidioList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DissidioDelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->salario_atual);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->salario_atual);
