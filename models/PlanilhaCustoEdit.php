 ...
 * Page class
 */
class PlanilhaCustoEdit extends PlanilhaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("idplanilha_custo") ?? Key(0) ?? Route(2)) !== null) {
                $this->idplanilha_custo->setQueryStringValue($keyValue);
                $this->idplanilha_custo->setOldValue($this->idplanilha_custo->QueryStringValue);
            } elseif (Post("idplanilha_custo") !== null) {
                $this->idplanilha_custo->setFormValue(Post("idplanilha_custo"));
                $this->idplanilha_custo->setOldValue($this->idplanilha_custo->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("idplanilha_custo") ?? Route("idplanilha_custo")) !== null) {
                    ...
                    $this->idplanilha_custo->CurrentValue = null;
                }
            }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("PlanilhaCustoList"); // No matching record, return to list
                        return;
                    }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "PlanilhaCustoList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "PlanilhaCustoList") {
                            ...
                            $returnUrl = "PlanilhaCustoList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idplanilha_custo->IsDetailKey) {
        ...
        if (!$this->calculo_idcalculo->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->calculo_idcalculo->setFormValue($val);
            }
        }
    }
    ...
    public function renderRow()
    {
        ...
        // idplanilha_custo
        $this->idplanilha_custo->RowCssClass = "row";
