 ...
 * Page class
 */
class MovInsumoContratoView extends MovInsumoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoContratoView";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoContratoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idmov_insumo_contrato") ?? Route("idmov_insumo_contrato")) !== null) {
            ...
            $returnUrl = "MovInsumoContratoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MovInsumoContratoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
