...
/**
 * Table class for view_uniforme_cargo_consolidado
 */
class ViewUniformeCargoConsolidado extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_uniforme_cargo_consolidado";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idcargo->addMethod("getDefault", fn() => 000);
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_uniforme_cargo_consolidado";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewUniformeCargoConsolidadoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewUniformeCargoConsolidadoView" => $Language->phrase("View"),
            "ViewUniformeCargoConsolidadoEdit" => $Language->phrase("Edit"),
            "ViewUniformeCargoConsolidadoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewUniformeCargoConsolidadoList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewUniformeCargoConsolidadoView",
            Config("API_ADD_ACTION") => "ViewUniformeCargoConsolidadoAdd",
            Config("API_EDIT_ACTION") => "ViewUniformeCargoConsolidadoEdit",
            Config("API_DELETE_ACTION") => "ViewUniformeCargoConsolidadoDelete",
            Config("API_LIST_ACTION") => "ViewUniformeCargoConsolidadoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewUniformeCargoConsolidadoView", $parm);
        } else {
            $url = $this->keyUrl("ViewUniformeCargoConsolidadoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewUniformeCargoConsolidadoAdd?" . $parm;
        } else {
            $url = "ViewUniformeCargoConsolidadoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewUniformeCargoConsolidadoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewUniformeCargoConsolidadoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewUniformeCargoConsolidadoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewUniformeCargoConsolidadoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewUniformeCargoConsolidadoDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewUniformeCargoConsolidadoList";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->idcargo->EditValue) != "" && is_numeric($this->idcargo->EditValue)) {
            $this->idcargo->EditValue = FormatNumber($this->idcargo->EditValue, null);
        }
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->vr_anual, '');
                $doc->exportAggregate($this->vr_mensal, '');
                $doc->endExportRow();
            }
        }
        if (!$doc->ExportCustom) {
