 ...
 * Page class
 */
class MovInsumoContratoDelete extends MovInsumoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoContratoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoContratoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MovInsumoContratoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MovInsumoContratoList"); // Return to list
                return;
            }
        }
