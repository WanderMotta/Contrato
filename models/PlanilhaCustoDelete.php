 ...
 * Page class
 */
class PlanilhaCustoDelete extends PlanilhaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PlanilhaCustoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PlanilhaCustoList"); // Return to list
                return;
            }
        }
