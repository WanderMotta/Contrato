 ...
 * Page class
 */
class PlanilhaCustoContratoCopyView extends PlanilhaCustoContratoCopy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoContratoCopyView";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoContratoCopyView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idplanilha_custo_contrato") ?? Route("idplanilha_custo_contrato")) !== null) {
            $this->RecKey["idplanilha_custo_contrato"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idplanilha_custo_contrato") ?? Route("idplanilha_custo_contrato")) !== null) {
            ...
            $this->RecKey["idplanilha_custo_contrato"] = $this->idplanilha_custo_contrato->QueryStringValue;
        } elseif (Post("idplanilha_custo_contrato") !== null) {
            $this->idplanilha_custo_contrato->setFormValue(Post("idplanilha_custo_contrato"));
            $this->RecKey["idplanilha_custo_contrato"] = $this->idplanilha_custo_contrato->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idplanilha_custo_contrato->setQueryStringValue($keyValue);
            $this->RecKey["idplanilha_custo_contrato"] = $this->idplanilha_custo_contrato->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PlanilhaCustoContratoCopyList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PlanilhaCustoContratoCopyList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
