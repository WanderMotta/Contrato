 ...
 * Page class
 */
class ContatoEdit extends Contato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContatoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContatoEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("idcontato") ?? Key(0) ?? Route(2)) !== null) {
                $this->idcontato->setQueryStringValue($keyValue);
                $this->idcontato->setOldValue($this->idcontato->QueryStringValue);
            } elseif (Post("idcontato") !== null) {
                $this->idcontato->setFormValue(Post("idcontato"));
                $this->idcontato->setOldValue($this->idcontato->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("idcontato") ?? Route("idcontato")) !== null) {
                    ...
                    $this->idcontato->CurrentValue = null;
                }
            }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->idcontato->Visible && $this->idcontato->Required) {
                if (!$this->idcontato->IsDetailKey && EmptyValue($this->idcontato->FormValue)) {
                    $this->idcontato->addErrorMessage(str_replace("%s", $this->idcontato->caption(), $this->idcontato->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // faturamento_idfaturamento
        if ($this->faturamento_idfaturamento->getSessionValue() != "") {
            $this->faturamento_idfaturamento->ReadOnly = true;
        }
        $this->faturamento_idfaturamento->setDbValueDef($rsnew, $this->faturamento_idfaturamento->CurrentValue, $this->faturamento_idfaturamento->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['faturamento_idfaturamento'])) { // faturamento_idfaturamento
            $this->faturamento_idfaturamento->CurrentValue = $row['faturamento_idfaturamento'];
        }
    }
