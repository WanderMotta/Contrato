 ...
 * Page class
 */
class PlanilhaCustoContratoCopyDelete extends PlanilhaCustoContratoCopy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoContratoCopyDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoContratoCopyDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PlanilhaCustoContratoCopyList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PlanilhaCustoContratoCopyList"); // Return to list
                return;
            }
        }
