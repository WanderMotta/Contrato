 ...
 * Page class
 */
class ItensModuloGrid extends ItensModulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItensModuloGrid";
    ...
    public $FormName = "fitens_modulogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ItensModuloGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "modulo") {
            $this->modulo_idmodulo->Visible = true; // Need to insert foreign key
            $this->modulo_idmodulo->CurrentValue = $this->modulo_idmodulo->getSessionValue();
        }
