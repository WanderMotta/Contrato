...
/**
 * Table class for view_export_previsto
 */
class ViewExportPrevisto extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_export_previsto";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idcliente->addMethod("getDefault", fn() => 000);
        ...
        $this->idcliente->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->local_idlocal->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->funcao_idfuncao->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_export_previsto";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewExportPrevistoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewExportPrevistoView" => $Language->phrase("View"),
            "ViewExportPrevistoEdit" => $Language->phrase("Edit"),
            "ViewExportPrevistoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewExportPrevistoView",
            Config("API_ADD_ACTION") => "ViewExportPrevistoAdd",
            Config("API_EDIT_ACTION") => "ViewExportPrevistoEdit",
            Config("API_DELETE_ACTION") => "ViewExportPrevistoDelete",
            Config("API_LIST_ACTION") => "ViewExportPrevistoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewExportPrevistoView", $parm);
        } else {
            $url = $this->keyUrl("ViewExportPrevistoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewExportPrevistoAdd?" . $parm;
        } else {
            $url = "ViewExportPrevistoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExportPrevistoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExportPrevistoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExportPrevistoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExportPrevistoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewExportPrevistoDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewExportPrevistoList";
    ...
    public function renderEditRow()
    {
        ...
        $this->local_idlocal->EditValue = $this->local_idlocal->CurrentValue;
        $this->local_idlocal->PlaceHolder = RemoveHtml($this->local_idlocal->caption());
        if (strval($this->local_idlocal->EditValue) != "" && is_numeric($this->local_idlocal->EditValue)) {
            $this->local_idlocal->EditValue = FormatNumber($this->local_idlocal->EditValue, null);
        }
