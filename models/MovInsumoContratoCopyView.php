 ...
 * Page class
 */
class MovInsumoContratoCopyView extends MovInsumoContratoCopy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoContratoCopyView";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoContratoCopyView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idmov_insumo_contrato") ?? Route("idmov_insumo_contrato")) !== null) {
            $this->RecKey["idmov_insumo_contrato"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idmov_insumo_contrato") ?? Route("idmov_insumo_contrato")) !== null) {
            ...
            $this->RecKey["idmov_insumo_contrato"] = $this->idmov_insumo_contrato->QueryStringValue;
        } elseif (Post("idmov_insumo_contrato") !== null) {
            $this->idmov_insumo_contrato->setFormValue(Post("idmov_insumo_contrato"));
            $this->RecKey["idmov_insumo_contrato"] = $this->idmov_insumo_contrato->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idmov_insumo_contrato->setQueryStringValue($keyValue);
            $this->RecKey["idmov_insumo_contrato"] = $this->idmov_insumo_contrato->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MovInsumoContratoCopyList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MovInsumoContratoCopyList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
