 ...
 * Page class
 */
class InsumoView extends Insumo
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "InsumoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idinsumo") ?? Route("idinsumo")) !== null) {
            ...
            $this->RecKey["idinsumo"] = $this->idinsumo->QueryStringValue;
        } elseif (Post("idinsumo") !== null) {
            $this->idinsumo->setFormValue(Post("idinsumo"));
            $this->RecKey["idinsumo"] = $this->idinsumo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idinsumo->setQueryStringValue($keyValue);
            $this->RecKey["idinsumo"] = $this->idinsumo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "InsumoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "InsumoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
