 ...
 * Page class
 */
class MovInsumoClienteView extends MovInsumoCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoClienteView";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoClienteView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idmov_insumo_cliente") ?? Route("idmov_insumo_cliente")) !== null) {
            $this->RecKey["idmov_insumo_cliente"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idmov_insumo_cliente") ?? Route("idmov_insumo_cliente")) !== null) {
            ...
            $this->RecKey["idmov_insumo_cliente"] = $this->idmov_insumo_cliente->QueryStringValue;
        } elseif (Post("idmov_insumo_cliente") !== null) {
            $this->idmov_insumo_cliente->setFormValue(Post("idmov_insumo_cliente"));
            $this->RecKey["idmov_insumo_cliente"] = $this->idmov_insumo_cliente->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idmov_insumo_cliente->setQueryStringValue($keyValue);
            $this->RecKey["idmov_insumo_cliente"] = $this->idmov_insumo_cliente->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MovInsumoClienteList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MovInsumoClienteList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
