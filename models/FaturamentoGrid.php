 ...
 * Page class
 */
class FaturamentoGrid extends Faturamento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaturamentoGrid";
    ...
    public $FormName = "ffaturamentogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "FaturamentoGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idfaturamento->CurrentValue;
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_faturamento") &&
            $CurrentForm->hasValue("o_faturamento") &&
            $this->faturamento->CurrentValue != $this->faturamento->DefaultValue &&
            !($this->faturamento->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->faturamento->CurrentValue == $this->faturamento->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_cnpj") &&
            $CurrentForm->hasValue("o_cnpj") &&
            $this->cnpj->CurrentValue != $this->cnpj->DefaultValue &&
            !($this->cnpj->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->cnpj->CurrentValue == $this->cnpj->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_endereco") &&
            $CurrentForm->hasValue("o_endereco") &&
            $this->endereco->CurrentValue != $this->endereco->DefaultValue &&
            !($this->endereco->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->endereco->CurrentValue == $this->endereco->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_bairro") &&
            $CurrentForm->hasValue("o_bairro") &&
            $this->bairro->CurrentValue != $this->bairro->DefaultValue &&
            !($this->bairro->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->bairro->CurrentValue == $this->bairro->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_cidade") &&
            $CurrentForm->hasValue("o_cidade") &&
            $this->cidade->CurrentValue != $this->cidade->DefaultValue &&
            !($this->cidade->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->cidade->CurrentValue == $this->cidade->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_uf") &&
            $CurrentForm->hasValue("o_uf") &&
            $this->uf->CurrentValue != $this->uf->DefaultValue &&
            !($this->uf->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->uf->CurrentValue == $this->uf->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_dia_vencimento") &&
            $CurrentForm->hasValue("o_dia_vencimento") &&
            $this->dia_vencimento->CurrentValue != $this->dia_vencimento->DefaultValue &&
            !($this->dia_vencimento->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->dia_vencimento->CurrentValue == $this->dia_vencimento->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_origem") &&
            $CurrentForm->hasValue("o_origem") &&
            $this->origem->CurrentValue != $this->origem->DefaultValue &&
            !($this->origem->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->origem->CurrentValue == $this->origem->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_faturamento")) {
            $this->faturamento->setOldValue($CurrentForm->getValue("o_faturamento"));
        }
        ...
        if ($CurrentForm->hasValue("o_cnpj")) {
            $this->cnpj->setOldValue($CurrentForm->getValue("o_cnpj"));
        }
        ...
        if ($CurrentForm->hasValue("o_endereco")) {
            $this->endereco->setOldValue($CurrentForm->getValue("o_endereco"));
        }
        ...
        if ($CurrentForm->hasValue("o_dia_vencimento")) {
            $this->dia_vencimento->setOldValue($CurrentForm->getValue("o_dia_vencimento"));
        }
        ...
        if ($CurrentForm->hasValue("o_origem")) {
            $this->origem->setOldValue($CurrentForm->getValue("o_origem"));
        }
        ...
        if (!$this->idfaturamento->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "cliente") {
            $this->cliente_idcliente->Visible = true; // Need to insert foreign key
            $this->cliente_idcliente->CurrentValue = $this->cliente_idcliente->getSessionValue();
        }
        ...
        $detailKeys = [];
        $detailKeys["cliente_idcliente"] = $this->cliente_idcliente->getSessionValue();
        $masterTable = Container("cliente");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        if ($this->cliente_idcliente->getSessionValue() != "") {
            $rsnew['cliente_idcliente'] = $this->cliente_idcliente->getSessionValue();
        }
        return $rsnew;
    }
