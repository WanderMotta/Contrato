...
/**
 * Table class for view_mov_pla_custo_modulos
 */
class ViewMovPlaCustoModulos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_mov_pla_custo_modulos";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->ativo->Raw = true;
        $this->ativo->Lookup = new Lookup($this->ativo, 'view_mov_pla_custo_modulos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewMovPlaCustoModulosList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewMovPlaCustoModulosView" => $Language->phrase("View"),
            "ViewMovPlaCustoModulosEdit" => $Language->phrase("Edit"),
            "ViewMovPlaCustoModulosAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewMovPlaCustoModulosList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewMovPlaCustoModulosView",
            Config("API_ADD_ACTION") => "ViewMovPlaCustoModulosAdd",
            Config("API_EDIT_ACTION") => "ViewMovPlaCustoModulosEdit",
            Config("API_DELETE_ACTION") => "ViewMovPlaCustoModulosDelete",
            Config("API_LIST_ACTION") => "ViewMovPlaCustoModulosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewMovPlaCustoModulosView", $parm);
        } else {
            $url = $this->keyUrl("ViewMovPlaCustoModulosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewMovPlaCustoModulosAdd?" . $parm;
        } else {
            $url = "ViewMovPlaCustoModulosAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewMovPlaCustoModulosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewMovPlaCustoModulosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewMovPlaCustoModulosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewMovPlaCustoModulosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewMovPlaCustoModulosDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewMovPlaCustoModulosList";
