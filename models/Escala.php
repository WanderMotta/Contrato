...
/**
 * Table class for escala
 */
class Escala extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // idescala
        $this->idescala = new DbField(
            $this, // Table
            'x_idescala', // Variable name
            'idescala', // Name
            '`idescala`', // Expression
            '`idescala`', // Basic search expression
            19, // Type
            2, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`idescala`', // Virtual expression
            false, // Is virtual
        ...
        $this->idescala->InputTextType = "text";
        $this->idescala->Raw = true;
        $this->idescala->IsAutoIncrement = true; // Autoincrement field
        $this->idescala->IsPrimaryKey = true; // Primary key field
        $this->idescala->Nullable = false; // NOT NULL field
        $this->idescala->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idescala->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idescala'] = &$this->idescala;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "escala";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idescala->setDbValue($conn->lastInsertId());
            $rs['idescala'] = $this->idescala->DbValue;
        }
        return $result;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idescala']) && !EmptyValue($this->idescala->CurrentValue)) {
                $rs['idescala'] = $this->idescala->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idescala', $rs)) {
                AddFilter($where, QuotedName('idescala', $this->Dbid) . '=' . QuotedValue($rs['idescala'], $this->idescala->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idescala->DbValue = $row['idescala'];
    ...
    {
        $keys = [];
        $val = $current ? $this->idescala->CurrentValue : $this->idescala->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idescala->CurrentValue = $keys[0];
            } else {
                $this->idescala->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('idescala', $row) ? $row['idescala'] : null;
        } else {
            $val = !EmptyValue($this->idescala->OldValue) && !$current ? $this->idescala->OldValue : $this->idescala->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@idescala@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EscalaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EscalaView" => $Language->phrase("View"),
            "EscalaEdit" => $Language->phrase("Edit"),
            "EscalaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EscalaView",
            Config("API_ADD_ACTION") => "EscalaAdd",
            Config("API_EDIT_ACTION") => "EscalaEdit",
            Config("API_DELETE_ACTION") => "EscalaDelete",
            Config("API_LIST_ACTION") => "EscalaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EscalaView", $parm);
        } else {
            $url = $this->keyUrl("EscalaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EscalaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EscalaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EscalaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EscalaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EscalaDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"idescala\":" . VarToJson($this->idescala->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->idescala->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->idescala->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("idescala") ?? Route("idescala")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idescala->CurrentValue = $key;
            } else {
                $this->idescala->OldValue = $key;
            }
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idescala);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->idescala, '');
                $doc->exportAggregate($this->escala, 'COUNT');
