 ...
 * Page class
 */
class DissidioList extends Dissidio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DissidioList";
    ...
    public $FormName = "fdissidiolist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "DissidioList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "DissidioDelete";
        $this->MultiUpdateUrl = "DissidioUpdate";
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "DissidioView"); // If View page, no primary button
                } else { // List page
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->salario_atual->AdvancedSearch->toJson(), ","); // Field salario_atual
        $filterList = Concat($filterList, $this->dissidio_anual_iddissidio_anual->AdvancedSearch->toJson(), ","); // Field dissidio_anual_iddissidio_anual
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fdissidiosrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field salario_atual
        $this->salario_atual->AdvancedSearch->SearchValue = @$filter["x_salario_atual"];
        $this->salario_atual->AdvancedSearch->SearchOperator = @$filter["z_salario_atual"];
        $this->salario_atual->AdvancedSearch->SearchCondition = @$filter["v_salario_atual"];
        $this->salario_atual->AdvancedSearch->SearchValue2 = @$filter["y_salario_atual"];
        $this->salario_atual->AdvancedSearch->SearchOperator2 = @$filter["w_salario_atual"];
        $this->salario_atual->AdvancedSearch->save();

        // Field dissidio_anual_iddissidio_anual
        $this->dissidio_anual_iddissidio_anual->AdvancedSearch->SearchValue = @$filter["x_dissidio_anual_iddissidio_anual"];
        $this->dissidio_anual_iddissidio_anual->AdvancedSearch->SearchOperator = @$filter["z_dissidio_anual_iddissidio_anual"];
        $this->dissidio_anual_iddissidio_anual->AdvancedSearch->SearchCondition = @$filter["v_dissidio_anual_iddissidio_anual"];
        $this->dissidio_anual_iddissidio_anual->AdvancedSearch->SearchValue2 = @$filter["y_dissidio_anual_iddissidio_anual"];
        $this->dissidio_anual_iddissidio_anual->AdvancedSearch->SearchOperator2 = @$filter["w_dissidio_anual_iddissidio_anual"];
        $this->dissidio_anual_iddissidio_anual->AdvancedSearch->save();
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdissidiolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdissidiolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "salario_atual");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdissidiosrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdissidiosrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
        ...
        if (!$this->isGridAdd() && !$this->isGridEdit() && !$this->isMultiEdit()) { // Not grid add/grid edit/multi edit mode
            ...
            foreach ($this->ListActions as $listAction) {
                if ($listAction->Select == ACTION_MULTIPLE) {
                    ...
                    $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdissidiolist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
            ...
            if ($this->isGridEdit()) {
                ...
                if (!($this->ModalGridEdit && !IsMobile())) {
                    ...
                    $option->UseDropDownButton = false;
                        ...
                        $item->Body = "<button class=\"ew-action ew-grid-save\" title=\"" . HtmlTitle($Language->phrase("GridSaveLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("GridSaveLink")) . "\" form=\"fdissidiolist\" formaction=\"" . GetUrl($this->pageName()) . "\">" . $Language->phrase("GridSaveLink") . "</button>";
    ...
    public function getRowHash($row)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['salario_atual']); // salario_atual
        return md5($hash);
    }
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdissidiosrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
