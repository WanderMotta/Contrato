 ...
 * Page class
 */
class ContatoGrid extends Contato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContatoGrid";
    ...
    public $FormName = "fcontatogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ContatoGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idcontato->CurrentValue;
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_contato") &&
            $CurrentForm->hasValue("o_contato") &&
            $this->contato->CurrentValue != $this->contato->DefaultValue &&
            !($this->contato->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->contato->CurrentValue == $this->contato->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_telefone") &&
            $CurrentForm->hasValue("o_telefone") &&
            $this->telefone->CurrentValue != $this->telefone->DefaultValue &&
            !($this->telefone->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->telefone->CurrentValue == $this->telefone->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_contato")) {
            $this->contato->setOldValue($CurrentForm->getValue("o_contato"));
        }
        ...
        if (!$this->idcontato->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->idcontato->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->idcontato->CurrentValue = $this->idcontato->FormValue;
        }
    ...
    protected function editRow()
    {
        ...
        $detailKeys = [];
        $keyValue = $rsnew['faturamento_idfaturamento'] ?? $rsold['faturamento_idfaturamento'];
        $detailKeys['faturamento_idfaturamento'] = $keyValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "faturamento") {
            $this->faturamento_idfaturamento->Visible = true; // Need to insert foreign key
            $this->faturamento_idfaturamento->CurrentValue = $this->faturamento_idfaturamento->getSessionValue();
        }
        ...
        $detailKeys = [];
        $detailKeys["faturamento_idfaturamento"] = $this->faturamento_idfaturamento->getSessionValue();
        $masterTable = Container("faturamento");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        if ($this->faturamento_idfaturamento->getSessionValue() != "") {
            $rsnew['faturamento_idfaturamento'] = $this->faturamento_idfaturamento->getSessionValue();
        }
        return $rsnew;
    }
