...
/**
 * Table class for rel_view_lucro_prejuizo
 */
class RelViewLucroPrejuizo extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'view_lucro_prejuizo_contratos'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->cliente->Lookup = new Lookup($this->cliente, 'view_lucro_prejuizo_contratos', true, 'cliente', ["cliente","","",""], '', '', [], [], [], [], [], [], false, '`cliente` ASC', '', "`cliente`");
        $this->cliente->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->cliente->SourceTableVar = 'view_lucro_prejuizo_contratos';
        $this->cliente->SearchType = "dropdown";
        $this->Fields['cliente'] = &$this->cliente;

        // Custo Calculado R$
        $this->CustoCalculadoR = new ReportField(
            $this, // Table
        ...
        $this->CustoCalculadoR->SourceTableVar = 'view_lucro_prejuizo_contratos';
        $this->Fields['Custo Calculado R$'] = &$this->CustoCalculadoR;

        // Vr Cobrado R$
        $this->VrCobradoR = new ReportField(
            $this, // Table
        ...
        $this->VrCobradoR->SourceTableVar = 'view_lucro_prejuizo_contratos';
        ...
        $this->Diferenca->SourceTableVar = 'view_lucro_prejuizo_contratos';
        ...
        $this->Margem->SourceTableVar = 'view_lucro_prejuizo_contratos';
        $this->Fields['Margem'] = &$this->Margem;

        // Resultado
        $this->Resultado = new ReportField(
            $this, // Table
        ...
        $this->Resultado->UseFilter = true; // Table header filter
        $this->Resultado->Lookup = new Lookup($this->Resultado, 'rel_view_lucro_prejuizo', true, 'Resultado', ["Resultado","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->Resultado->SourceTableVar = 'view_lucro_prejuizo_contratos';
        $this->Resultado->SearchType = "dropdown";
        ...
        $this->LucroxPrejuizo->Position = 3;
        ...
        $this->LucroxPrejuizo->SortType = 2;
        ...
        $this->LucroxPrejuizo->SqlOrderBy = "`cliente` DESC";
        $this->LucroxPrejuizo->SeriesDateType = "";
        $this->LucroxPrejuizo->ID = "rel_view_lucro_prejuizo_LucroxPrejuizo"; // Chart ID
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("SUM(`Custo Calculado R\$`) AS sum_custocalculador, SUM(`Vr Cobrado R\$`) AS sum_vrcobrador, SUM(`Diferença`) AS sum_diferenca");
    }
    ...
    {
        if ($chartVar == "LucroxPrejuizo") {
            $this->cliente->CurrentValue = $chartRow[0];
            $arwrk = [];
            ...
            $chartRow[0] = is_object($this->cliente->ViewValue) ? $this->cliente->ViewValue->__toString() : $this->cliente->ViewValue;
        }
        return $chartRow;
    }
    ...
    {
        return "RelViewLucroPrejuizo";
    }

    // API page name
    public function getApiPageName($action)
    {
        return "RelViewLucroPrejuizoSummary";
    }
