...
/**
 * Table class for mov_insumo_contrato_copy
 */
class MovInsumoContratoCopy extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "mov_insumo_contrato_copy";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->tipo_insumo_idtipo_insumo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "mov_insumo_contrato_copy";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MovInsumoContratoCopyList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MovInsumoContratoCopyView" => $Language->phrase("View"),
            "MovInsumoContratoCopyEdit" => $Language->phrase("Edit"),
            "MovInsumoContratoCopyAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "MovInsumoContratoCopyList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MovInsumoContratoCopyView",
            Config("API_ADD_ACTION") => "MovInsumoContratoCopyAdd",
            Config("API_EDIT_ACTION") => "MovInsumoContratoCopyEdit",
            Config("API_DELETE_ACTION") => "MovInsumoContratoCopyDelete",
            Config("API_LIST_ACTION") => "MovInsumoContratoCopyList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MovInsumoContratoCopyView", $parm);
        } else {
            $url = $this->keyUrl("MovInsumoContratoCopyView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MovInsumoContratoCopyAdd?" . $parm;
        } else {
            $url = "MovInsumoContratoCopyAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoCopyEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoCopyList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoCopyAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovInsumoContratoCopyList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MovInsumoContratoCopyDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "MovInsumoContratoCopyList";
