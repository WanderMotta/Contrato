 ...
 * Page class
 */
class BeneficiosView extends Beneficios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BeneficiosView";
    ...
    // CSS class/style
    public $CurrentPageName = "BeneficiosView";
    ...
    public function setVisibility()
    {
        ...
        $this->dissidio_anual_iddissidio_anual->setVisibility();
    }
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idbeneficios") ?? Route("idbeneficios")) !== null) {
            $this->RecKey["idbeneficios"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idbeneficios") ?? Route("idbeneficios")) !== null) {
            ...
            $this->RecKey["idbeneficios"] = $this->idbeneficios->QueryStringValue;
        } elseif (Post("idbeneficios") !== null) {
            $this->idbeneficios->setFormValue(Post("idbeneficios"));
            $this->RecKey["idbeneficios"] = $this->idbeneficios->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idbeneficios->setQueryStringValue($keyValue);
            $this->RecKey["idbeneficios"] = $this->idbeneficios->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "BeneficiosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BeneficiosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
