...
/**
 * Table class for rel_teste
 */
class RelTeste extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->idplanilha_custo->Lookup = new Lookup($this->idplanilha_custo, 'rel_teste', true, 'idplanilha_custo', ["idplanilha_custo","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
