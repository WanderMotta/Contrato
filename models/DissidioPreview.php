 ...
 * Page class
 */
class DissidioPreview extends Dissidio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DissidioPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "DissidioPreview";
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->CurrentOrder !== "") {
            ...
            $this->updateSort($this->salario_atual, $ctrl); // salario_atual
        }
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "dissidio_anual") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=dissidio_anual&" . GetForeignKeyUrl("fk_iddissidio_anual", $this->dissidio_anual_iddissidio_anual->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "dissidio_anual") {
            $this->dissidio_anual_iddissidio_anual->setQueryStringValue($keys[0] ?? "");
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DissidioList"), "", $this->TableVar, true);
        $pageId = "preview";
