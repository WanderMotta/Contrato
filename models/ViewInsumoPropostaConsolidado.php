...
/**
 * Table class for view_insumo_proposta_consolidado
 */
class ViewInsumoPropostaConsolidado extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_insumo_proposta_consolidado";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->vr_mensal->InputTextType = "text";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_insumo_proposta_consolidado";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewInsumoPropostaConsolidadoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewInsumoPropostaConsolidadoView" => $Language->phrase("View"),
            "ViewInsumoPropostaConsolidadoEdit" => $Language->phrase("Edit"),
            "ViewInsumoPropostaConsolidadoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewInsumoPropostaConsolidadoList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewInsumoPropostaConsolidadoView",
            Config("API_ADD_ACTION") => "ViewInsumoPropostaConsolidadoAdd",
            Config("API_EDIT_ACTION") => "ViewInsumoPropostaConsolidadoEdit",
            Config("API_DELETE_ACTION") => "ViewInsumoPropostaConsolidadoDelete",
            Config("API_LIST_ACTION") => "ViewInsumoPropostaConsolidadoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInsumoPropostaConsolidadoView", $parm);
        } else {
            $url = $this->keyUrl("ViewInsumoPropostaConsolidadoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewInsumoPropostaConsolidadoAdd?" . $parm;
        } else {
            $url = "ViewInsumoPropostaConsolidadoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaConsolidadoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaConsolidadoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaConsolidadoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaConsolidadoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewInsumoPropostaConsolidadoDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewInsumoPropostaConsolidadoList";
