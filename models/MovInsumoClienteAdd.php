 ...
 * Page class
 */
class MovInsumoClienteAdd extends MovInsumoCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovInsumoClienteAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MovInsumoClienteAdd";
    ...
    public function setVisibility()
    {
        ...
        $this->vr_unit->Visible = false;
        $this->vr_total->Visible = false;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MovInsumoClienteView") {
