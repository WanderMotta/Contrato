 ...
 * Page class
 */
class ContatoDelete extends Contato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContatoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContatoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContatoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContatoList"); // Return to list
                return;
            }
        }
