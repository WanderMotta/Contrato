...
/**
 * Table class for view_insumo_proposta_detalhada
 */
class ViewInsumoPropostaDetalhada extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_insumo_proposta_detalhada";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idtipo_idinsumo
        $this->idtipo_idinsumo = new DbField(
            $this, // Table
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->anual->DbValue = $row['anual'];
        $this->mensal->DbValue = $row['mensal'];
        $this->idtipo_idinsumo->DbValue = $row['idtipo_idinsumo'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewInsumoPropostaDetalhadaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewInsumoPropostaDetalhadaView" => $Language->phrase("View"),
            "ViewInsumoPropostaDetalhadaEdit" => $Language->phrase("Edit"),
            "ViewInsumoPropostaDetalhadaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewInsumoPropostaDetalhadaList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewInsumoPropostaDetalhadaView",
            Config("API_ADD_ACTION") => "ViewInsumoPropostaDetalhadaAdd",
            Config("API_EDIT_ACTION") => "ViewInsumoPropostaDetalhadaEdit",
            Config("API_DELETE_ACTION") => "ViewInsumoPropostaDetalhadaDelete",
            Config("API_LIST_ACTION") => "ViewInsumoPropostaDetalhadaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInsumoPropostaDetalhadaView", $parm);
        } else {
            $url = $this->keyUrl("ViewInsumoPropostaDetalhadaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewInsumoPropostaDetalhadaAdd?" . $parm;
        } else {
            $url = "ViewInsumoPropostaDetalhadaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaDetalhadaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaDetalhadaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaDetalhadaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInsumoPropostaDetalhadaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewInsumoPropostaDetalhadaDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewInsumoPropostaDetalhadaList";
    ...
    public function renderEditRow()
    {
        ...
        // anual
        $this->anual->setupEditAttributes();
        $this->anual->EditValue = $this->anual->CurrentValue;
        $this->anual->PlaceHolder = RemoveHtml($this->anual->caption());
        if (strval($this->anual->EditValue) != "" && is_numeric($this->anual->EditValue)) {
            $this->anual->EditValue = FormatNumber($this->anual->EditValue, null);
        }

        // mensal
        $this->mensal->setupEditAttributes();
        $this->mensal->EditValue = $this->mensal->CurrentValue;
        $this->mensal->PlaceHolder = RemoveHtml($this->mensal->caption());
        if (strval($this->mensal->EditValue) != "" && is_numeric($this->mensal->EditValue)) {
            $this->mensal->EditValue = FormatNumber($this->mensal->EditValue, null);
        }

        // idtipo_idinsumo
        $this->idtipo_idinsumo->setupEditAttributes();
        $this->idtipo_idinsumo->EditValue = $this->idtipo_idinsumo->CurrentValue;
        $this->idtipo_idinsumo->PlaceHolder = RemoveHtml($this->idtipo_idinsumo->caption());
        if (strval($this->idtipo_idinsumo->EditValue) != "" && is_numeric($this->idtipo_idinsumo->EditValue)) {
            $this->idtipo_idinsumo->EditValue = FormatNumber($this->idtipo_idinsumo->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->anual);
                    $doc->exportCaption($this->mensal);
                    $doc->exportCaption($this->idtipo_idinsumo);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->anual);
                        $doc->exportField($this->mensal);
                        $doc->exportField($this->idtipo_idinsumo);
