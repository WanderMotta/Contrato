 ...
 * Page class
 */
class ContatoPreview extends Contato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContatoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ContatoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "faturamento") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=faturamento&" . GetForeignKeyUrl("fk_idfaturamento", $this->faturamento_idfaturamento->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "faturamento") {
            $this->faturamento_idfaturamento->setQueryStringValue($keys[0] ?? "");
        }
    }
