 ...
 * Page class
 */
class MovimentoPlaCustoPreview extends MovimentoPlaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimentoPlaCustoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimentoPlaCustoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "planilha_custo") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=planilha_custo&" . GetForeignKeyUrl("fk_idplanilha_custo", $this->planilha_custo_idplanilha_custo->QueryStringValue) . "";
        }
        if ($masterTblVar == "calculo") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=calculo&" . GetForeignKeyUrl("fk_idcalculo", $this->calculo_idcalculo->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "planilha_custo") {
            $this->planilha_custo_idplanilha_custo->setQueryStringValue($keys[0] ?? "");
        }
        if ($masterTblVar == "calculo") {
            $this->calculo_idcalculo->setQueryStringValue($keys[0] ?? "");
        }
    }
