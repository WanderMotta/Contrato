 ...
 * Page class
 */
class MovimentoPlaCustoView extends MovimentoPlaCusto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimentoPlaCustoView";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimentoPlaCustoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idmovimento_pla_custo") ?? Route("idmovimento_pla_custo")) !== null) {
            $this->RecKey["idmovimento_pla_custo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idmovimento_pla_custo") ?? Route("idmovimento_pla_custo")) !== null) {
            ...
            $this->RecKey["idmovimento_pla_custo"] = $this->idmovimento_pla_custo->QueryStringValue;
        } elseif (Post("idmovimento_pla_custo") !== null) {
            $this->idmovimento_pla_custo->setFormValue(Post("idmovimento_pla_custo"));
            $this->RecKey["idmovimento_pla_custo"] = $this->idmovimento_pla_custo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idmovimento_pla_custo->setQueryStringValue($keyValue);
            $this->RecKey["idmovimento_pla_custo"] = $this->idmovimento_pla_custo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MovimentoPlaCustoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MovimentoPlaCustoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
