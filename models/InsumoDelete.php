 ...
 * Page class
 */
class InsumoDelete extends Insumo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InsumoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "InsumoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("InsumoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("InsumoList"); // Return to list
                return;
            }
        }
