...
/**
 * Table class for view_rel_cargo_custo_indv
 */
class ViewRelCargoCustoIndv extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_rel_cargo_custo_indv";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->vr_contrato->DbValue = $row['vr_contrato'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewRelCargoCustoIndvList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewRelCargoCustoIndvView" => $Language->phrase("View"),
            "ViewRelCargoCustoIndvEdit" => $Language->phrase("Edit"),
            "ViewRelCargoCustoIndvAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewRelCargoCustoIndvList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewRelCargoCustoIndvView",
            Config("API_ADD_ACTION") => "ViewRelCargoCustoIndvAdd",
            Config("API_EDIT_ACTION") => "ViewRelCargoCustoIndvEdit",
            Config("API_DELETE_ACTION") => "ViewRelCargoCustoIndvDelete",
            Config("API_LIST_ACTION") => "ViewRelCargoCustoIndvList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewRelCargoCustoIndvView", $parm);
        } else {
            $url = $this->keyUrl("ViewRelCargoCustoIndvView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewRelCargoCustoIndvAdd?" . $parm;
        } else {
            $url = "ViewRelCargoCustoIndvAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewRelCargoCustoIndvEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewRelCargoCustoIndvList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewRelCargoCustoIndvAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewRelCargoCustoIndvList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewRelCargoCustoIndvDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewRelCargoCustoIndvList";
    ...
    public function renderEditRow()
    {
        ...
        // vr_contrato
        $this->vr_contrato->setupEditAttributes();
        $this->vr_contrato->EditValue = $this->vr_contrato->CurrentValue;
        $this->vr_contrato->PlaceHolder = RemoveHtml($this->vr_contrato->caption());
        if (strval($this->vr_contrato->EditValue) != "" && is_numeric($this->vr_contrato->EditValue)) {
            $this->vr_contrato->EditValue = FormatNumber($this->vr_contrato->EditValue, null);
        }
        ...
        if (strval($this->idmodulo->EditValue) != "" && is_numeric($this->idmodulo->EditValue)) {
            $this->idmodulo->EditValue = FormatNumber($this->idmodulo->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->vr_contrato);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->vr_contrato);
