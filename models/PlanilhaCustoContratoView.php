 ...
 * Page class
 */
class PlanilhaCustoContratoView extends PlanilhaCustoContrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanilhaCustoContratoView";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanilhaCustoContratoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idplanilha_custo_contrato") ?? Route("idplanilha_custo_contrato")) !== null) {
            ...
            $returnUrl = "PlanilhaCustoContratoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PlanilhaCustoContratoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
