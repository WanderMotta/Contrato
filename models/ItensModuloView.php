 ...
 * Page class
 */
class ItensModuloView extends ItensModulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItensModuloView";
    ...
    // CSS class/style
    public $CurrentPageName = "ItensModuloView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("iditens_modulo") ?? Route("iditens_modulo")) !== null) {
            $this->RecKey["iditens_modulo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("iditens_modulo") ?? Route("iditens_modulo")) !== null) {
            ...
            $this->RecKey["iditens_modulo"] = $this->iditens_modulo->QueryStringValue;
        } elseif (Post("iditens_modulo") !== null) {
            $this->iditens_modulo->setFormValue(Post("iditens_modulo"));
            $this->RecKey["iditens_modulo"] = $this->iditens_modulo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->iditens_modulo->setQueryStringValue($keyValue);
            $this->RecKey["iditens_modulo"] = $this->iditens_modulo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ItensModuloList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ItensModuloList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
