 ...
 * Page class
 */
class ItensModuloDelete extends ItensModulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItensModuloDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ItensModuloDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ItensModuloList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ItensModuloList"); // Return to list
                return;
            }
        }
