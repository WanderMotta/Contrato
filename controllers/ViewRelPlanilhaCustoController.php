...
class ViewRelPlanilhaCustoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewRelPlanilhaCustoList[/{idproposta}]", [PermissionMiddleware::class], "list.view_rel_planilha_custo")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewRelPlanilhaCustoList");
    }
}
