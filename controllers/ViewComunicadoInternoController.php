...
class ViewComunicadoInternoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewComunicadoInternoList[/{idproposta}]", [PermissionMiddleware::class], "list.view_comunicado_interno")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewComunicadoInternoList");
    }
}
