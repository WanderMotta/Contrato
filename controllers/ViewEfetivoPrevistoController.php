...
class ViewEfetivoPrevistoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewEfetivoPrevistoList[/{idcontrato}]", [PermissionMiddleware::class], "list.view_efetivo_previsto")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewEfetivoPrevistoList");
    }
}
