...
class ViewContratoValorAtualizadoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewContratoValorAtualizadoList", [PermissionMiddleware::class], "list.view_contrato_valor_atualizado")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewContratoValorAtualizadoList");
    }
}
