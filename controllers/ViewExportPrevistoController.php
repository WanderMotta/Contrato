...
class ViewExportPrevistoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewExportPrevistoList", [PermissionMiddleware::class], "list.view_export_previsto")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewExportPrevistoList");
    }
}
