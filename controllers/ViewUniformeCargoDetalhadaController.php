...
class ViewUniformeCargoDetalhadaController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewUniformeCargoDetalhadaList[/{iduniforme_cargo}]", [PermissionMiddleware::class], "list.view_uniforme_cargo_detalhada")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewUniformeCargoDetalhadaList");
    }
}
