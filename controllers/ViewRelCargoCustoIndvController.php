...
class ViewRelCargoCustoIndvController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewRelCargoCustoIndvList", [PermissionMiddleware::class], "list.view_rel_cargo_custo_indv")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewRelCargoCustoIndvList");
    }
}
