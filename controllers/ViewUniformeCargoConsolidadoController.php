...
class ViewUniformeCargoConsolidadoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewUniformeCargoConsolidadoList", [PermissionMiddleware::class], "list.view_uniforme_cargo_consolidado")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewUniformeCargoConsolidadoList");
    }
}
