...
/**
 * rel_planilha_custo controller
 */
class RelPlanilhaCustoController extends ControllerBase
{
    // summary
    #[Map(["GET", "POST", "OPTIONS"], "/RelPlanilhaCusto", [PermissionMiddleware::class], "summary.rel_planilha_custo")]
    public function summary(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "RelPlanilhaCustoSummary");
    }
}
