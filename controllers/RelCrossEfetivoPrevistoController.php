...
/**
 * rel_cross_efetivo_previsto controller
 */
class RelCrossEfetivoPrevistoController extends ControllerBase
{
    // crosstab
    #[Map(["GET", "POST", "OPTIONS"], "/RelCrossEfetivoPrevisto", [PermissionMiddleware::class], "crosstab.rel_cross_efetivo_previsto")]
    public function crosstab(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "RelCrossEfetivoPrevistoCrosstab");
    }
}
