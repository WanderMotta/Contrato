...
class ViewMovPlaCustoModulosController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewMovPlaCustoModulosList", [PermissionMiddleware::class], "list.view_mov_pla_custo_modulos")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewMovPlaCustoModulosList");
    }
}
