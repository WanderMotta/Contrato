...
class ViewCustoSalarioController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewCustoSalarioList[/{idcargo}]", [PermissionMiddleware::class], "list.view_custo_salario")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewCustoSalarioList");
    }
}
