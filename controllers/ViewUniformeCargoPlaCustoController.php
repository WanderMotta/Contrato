...
class ViewUniformeCargoPlaCustoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewUniformeCargoPlaCustoList[/{idplanilha_custo}]", [PermissionMiddleware::class], "list.view_uniforme_cargo_pla_custo")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewUniformeCargoPlaCustoList");
    }
}
