...
class ViewInsumoPropostaConsolidadoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ViewInsumoPropostaConsolidadoList", [PermissionMiddleware::class], "list.view_insumo_proposta_consolidado")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ViewInsumoPropostaConsolidadoList");
    }
}
