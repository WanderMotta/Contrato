...
/**
 * Entity class for "planilha_custo" table
 */
#[Entity]
#[Table(name: "planilha_custo")]
class PlanilhaCusto extends AbstractEntity
{
    #[Id]
    #[Column(name: "idplanilha_custo", type: "integer", unique: true)]
    #[GeneratedValue]
