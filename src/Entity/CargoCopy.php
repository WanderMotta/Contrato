...
/**
 * Entity class for "cargo_copy" table
 */
#[Entity]
#[Table(name: "cargo_copy")]
class CargoCopy extends AbstractEntity
{
    #[Id]
    ...
    public function getSalario1(): ?string
    {
        return $this->salario1;
    }

    public function setSalario1(?string $value): static
    {
        $this->salario1 = $value;
        return $this;
    }
