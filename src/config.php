...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/contratos.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-green", // CSS class(es) for sidebar
    ...
    "AES_ENCRYPTION_KEY" => "+XlQLvEz//u0TGCexSPRqe/bJdjkdJFj9M5MtptZFLQ=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\contratos\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\contratos\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-358b62e2-6abc-4239-893d-0fd59d02abf9", // Export folder
    ...
    // Email
    "SENDER_EMAIL" => "comercial@amixxam.com.br", // Sender email address
    "RECIPIENT_EMAIL" => "comercial@amixxam.com.br", // Recipient email address
