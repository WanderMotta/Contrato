...
?>
<main class="view">
<form name="fmov_insumo_contratoview" id="fmov_insumo_contratoview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fmov_insumo_contratoview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->idmov_insumo_contrato->Visible) { // idmov_insumo_contrato ?>
    <tr id="r_idmov_insumo_contrato"<?= $Page->idmov_insumo_contrato->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_idmov_insumo_contrato"><?= $Page->idmov_insumo_contrato->caption() ?></span></td>
...
<?php if ($Page->dt_cadastro->Visible) { // dt_cadastro ?>
    <tr id="r_dt_cadastro"<?= $Page->dt_cadastro->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_dt_cadastro"><?= $Page->dt_cadastro->caption() ?></span></td>
        <td data-name="dt_cadastro"<?= $Page->dt_cadastro->cellAttributes() ?>>
<span id="el_mov_insumo_contrato_dt_cadastro">
...
<?php if ($Page->tipo_insumo_idtipo_insumo->Visible) { // tipo_insumo_idtipo_insumo ?>
    <tr id="r_tipo_insumo_idtipo_insumo"<?= $Page->tipo_insumo_idtipo_insumo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_tipo_insumo_idtipo_insumo"><?= $Page->tipo_insumo_idtipo_insumo->caption() ?></span></td>
...
<?php if ($Page->insumo_idinsumo->Visible) { // insumo_idinsumo ?>
    <tr id="r_insumo_idinsumo"<?= $Page->insumo_idinsumo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_insumo_idinsumo"><?= $Page->insumo_idinsumo->caption() ?></span></td>
...
<?php if ($Page->qtde->Visible) { // qtde ?>
    <tr id="r_qtde"<?= $Page->qtde->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_qtde"><?= $Page->qtde->caption() ?></span></td>
...
<?php if ($Page->vr_unit->Visible) { // vr_unit ?>
    <tr id="r_vr_unit"<?= $Page->vr_unit->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_vr_unit"><?= $Page->vr_unit->caption() ?></span></td>
...
<?php if ($Page->frequencia->Visible) { // frequencia ?>
    <tr id="r_frequencia"<?= $Page->frequencia->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_frequencia"><?= $Page->frequencia->caption() ?></span></td>
...
<?php if ($Page->contrato_idcontrato->Visible) { // contrato_idcontrato ?>
    <tr id="r_contrato_idcontrato"<?= $Page->contrato_idcontrato->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mov_insumo_contrato_contrato_idcontrato"><?= $Page->contrato_idcontrato->caption() ?></span></td>
