...
// Page object
$PlanilhaCustoContratoCopyEdit = &$Page;
?>
...
?>
<main class="edit">
<form name="fplanilha_custo_contrato_copyedit" id="fplanilha_custo_contrato_copyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { planilha_custo_contrato_copy: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fplanilha_custo_contrato_copyedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fplanilha_custo_contrato_copyedit")
        .setPageId("edit")
...
<?php if ($Page->idplanilha_custo_contrato->Visible) { // idplanilha_custo_contrato ?>
    <div id="r_idplanilha_custo_contrato"<?= $Page->idplanilha_custo_contrato->rowAttributes() ?>>
        <label id="elh_planilha_custo_contrato_copy_idplanilha_custo_contrato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idplanilha_custo_contrato->caption() ?><?= $Page->idplanilha_custo_contrato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="planilha_custo_contrato_copy" data-field="x_idplanilha_custo_contrato" data-hidden="1" name="x_idplanilha_custo_contrato" id="x_idplanilha_custo_contrato" value="<?= HtmlEncode($Page->idplanilha_custo_contrato->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fplanilha_custo_contrato_copyedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fplanilha_custo_contrato_copyedit", "x_dt_cadastro", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fplanilha_custo_contrato_copyedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fplanilha_custo_contrato_copyedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
