...
// Page object
$PlanilhaCustoPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { planilha_custo: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->idplanilha_custo->Visible) { // idplanilha_custo ?>
    <?php if (!$Page->idplanilha_custo->Sortable || !$Page->sortUrl($Page->idplanilha_custo)) { ?>
        <th class="<?= $Page->idplanilha_custo->headerCellClass() ?>"><?= $Page->idplanilha_custo->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->idplanilha_custo->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->idplanilha_custo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idplanilha_custo->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->idplanilha_custo->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->idplanilha_custo->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->proposta_idproposta->Visible) { // proposta_idproposta ?>
    <?php if (!$Page->proposta_idproposta->Sortable || !$Page->sortUrl($Page->proposta_idproposta)) { ?>
        <th class="<?= $Page->proposta_idproposta->headerCellClass() ?>"><?= $Page->proposta_idproposta->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->proposta_idproposta->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->proposta_idproposta->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->proposta_idproposta->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->proposta_idproposta->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->proposta_idproposta->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->escala_idescala->Visible) { // escala_idescala ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->escala_idescala->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->escala_idescala->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->escala_idescala->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->periodo_idperiodo->Visible) { // periodo_idperiodo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->periodo_idperiodo->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->periodo_idperiodo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->periodo_idperiodo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->tipo_intrajornada_idtipo_intrajornada->Visible) { // tipo_intrajornada_idtipo_intrajornada ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tipo_intrajornada_idtipo_intrajornada->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->tipo_intrajornada_idtipo_intrajornada->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tipo_intrajornada_idtipo_intrajornada->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->cargo_idcargo->Visible) { // cargo_idcargo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->cargo_idcargo->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->cargo_idcargo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->cargo_idcargo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->acumulo_funcao->Visible) { // acumulo_funcao ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->acumulo_funcao->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->acumulo_funcao->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->acumulo_funcao->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->quantidade->Visible) { // quantidade ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->quantidade->headerCellClass() ?>"><div role="button" data-table="planilha_custo" data-sort="<?= HtmlEncode($Page->quantidade->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->quantidade->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->idplanilha_custo->Visible) { // idplanilha_custo ?>
        <!-- idplanilha_custo -->
        <td class="<?= $Page->idplanilha_custo->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php if ($Page->proposta_idproposta->Visible) { // proposta_idproposta ?>
        <!-- proposta_idproposta -->
        <td class="<?= $Page->proposta_idproposta->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php if ($Page->escala_idescala->Visible) { // escala_idescala ?>
