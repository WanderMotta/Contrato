...
<?php if ($Page->_userlevel->Visible) { // userlevel ?>
        <th data-name="_userlevel" class="<?= $Page->_userlevel->headerCellClass() ?>"><div id="elh_usuario__userlevel" class="usuario__userlevel"><?= $Page->renderFieldHeader($Page->_userlevel) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_usuario__userlevel" class="el_usuario__userlevel">
