...
// Page object
$MovInsumoContratoPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { mov_insumo_contrato: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->dt_cadastro->Visible) { // dt_cadastro ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->dt_cadastro->headerCellClass() ?>"><div role="button" data-table="mov_insumo_contrato" data-sort="<?= HtmlEncode($Page->dt_cadastro->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->dt_cadastro->getNextSort() ?>">
...
<?php if ($Page->tipo_insumo_idtipo_insumo->Visible) { // tipo_insumo_idtipo_insumo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tipo_insumo_idtipo_insumo->headerCellClass() ?>"><div role="button" data-table="mov_insumo_contrato" data-sort="<?= HtmlEncode($Page->tipo_insumo_idtipo_insumo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tipo_insumo_idtipo_insumo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->insumo_idinsumo->Visible) { // insumo_idinsumo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->insumo_idinsumo->headerCellClass() ?>"><div role="button" data-table="mov_insumo_contrato" data-sort="<?= HtmlEncode($Page->insumo_idinsumo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->insumo_idinsumo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->qtde->Visible) { // qtde ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->qtde->headerCellClass() ?>"><div role="button" data-table="mov_insumo_contrato" data-sort="<?= HtmlEncode($Page->qtde->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->qtde->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->vr_unit->Visible) { // vr_unit ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->vr_unit->headerCellClass() ?>"><div role="button" data-table="mov_insumo_contrato" data-sort="<?= HtmlEncode($Page->vr_unit->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->vr_unit->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->frequencia->Visible) { // frequencia ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->frequencia->headerCellClass() ?>"><div role="button" data-table="mov_insumo_contrato" data-sort="<?= HtmlEncode($Page->frequencia->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->frequencia->getNextSort() ?>">
            <div class="ew-table-header-btn">
