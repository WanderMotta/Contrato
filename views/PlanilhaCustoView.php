...
?>
<main class="view">
<form name="fplanilha_custoview" id="fplanilha_custoview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->idplanilha_custo->Visible) { // idplanilha_custo ?>
    <tr id="r_idplanilha_custo"<?= $Page->idplanilha_custo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_idplanilha_custo"><?= $Page->idplanilha_custo->caption() ?></span></td>
...
<?php if ($Page->proposta_idproposta->Visible) { // proposta_idproposta ?>
    <tr id="r_proposta_idproposta"<?= $Page->proposta_idproposta->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_proposta_idproposta"><?= $Page->proposta_idproposta->caption() ?></span></td>
...
<?php if ($Page->dt_cadastro->Visible) { // dt_cadastro ?>
    <tr id="r_dt_cadastro"<?= $Page->dt_cadastro->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_dt_cadastro"><?= $Page->dt_cadastro->caption() ?></span></td>
        <td data-name="dt_cadastro"<?= $Page->dt_cadastro->cellAttributes() ?>>
<span id="el_planilha_custo_dt_cadastro">
...
<?php if ($Page->escala_idescala->Visible) { // escala_idescala ?>
    <tr id="r_escala_idescala"<?= $Page->escala_idescala->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_escala_idescala"><?= $Page->escala_idescala->caption() ?></span></td>
...
<?php if ($Page->periodo_idperiodo->Visible) { // periodo_idperiodo ?>
    <tr id="r_periodo_idperiodo"<?= $Page->periodo_idperiodo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_periodo_idperiodo"><?= $Page->periodo_idperiodo->caption() ?></span></td>
...
<?php if ($Page->tipo_intrajornada_idtipo_intrajornada->Visible) { // tipo_intrajornada_idtipo_intrajornada ?>
    <tr id="r_tipo_intrajornada_idtipo_intrajornada"<?= $Page->tipo_intrajornada_idtipo_intrajornada->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_tipo_intrajornada_idtipo_intrajornada"><?= $Page->tipo_intrajornada_idtipo_intrajornada->caption() ?></span></td>
...
<?php if ($Page->cargo_idcargo->Visible) { // cargo_idcargo ?>
    <tr id="r_cargo_idcargo"<?= $Page->cargo_idcargo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_cargo_idcargo"><?= $Page->cargo_idcargo->caption() ?></span></td>
...
<?php if ($Page->acumulo_funcao->Visible) { // acumulo_funcao ?>
    <tr id="r_acumulo_funcao"<?= $Page->acumulo_funcao->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_acumulo_funcao"><?= $Page->acumulo_funcao->caption() ?></span></td>
...
<?php if ($Page->quantidade->Visible) { // quantidade ?>
    <tr id="r_quantidade"<?= $Page->quantidade->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_quantidade"><?= $Page->quantidade->caption() ?></span></td>
...
<?php if ($Page->usuario_idusuario->Visible) { // usuario_idusuario ?>
    <tr id="r_usuario_idusuario"<?= $Page->usuario_idusuario->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_usuario_idusuario"><?= $Page->usuario_idusuario->caption() ?></span></td>
        <td data-name="usuario_idusuario"<?= $Page->usuario_idusuario->cellAttributes() ?>>
<span id="el_planilha_custo_usuario_idusuario">
...
<?php if ($Page->calculo_idcalculo->Visible) { // calculo_idcalculo ?>
    <tr id="r_calculo_idcalculo"<?= $Page->calculo_idcalculo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_calculo_idcalculo"><?= $Page->calculo_idcalculo->caption() ?></span></td>
