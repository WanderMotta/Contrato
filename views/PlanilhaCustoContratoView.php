...
// Page object
$PlanilhaCustoContratoView = &$Page;
?>
...
?>
<main class="view">
<form name="fplanilha_custo_contratoview" id="fplanilha_custo_contratoview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
var currentForm;
var fplanilha_custo_contratoview;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fplanilha_custo_contratoview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->idplanilha_custo_contrato->Visible) { // idplanilha_custo_contrato ?>
    <tr id="r_idplanilha_custo_contrato"<?= $Page->idplanilha_custo_contrato->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_idplanilha_custo_contrato"><?= $Page->idplanilha_custo_contrato->caption() ?></span></td>
...
<?php if ($Page->dt_cadastro->Visible) { // dt_cadastro ?>
    <tr id="r_dt_cadastro"<?= $Page->dt_cadastro->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_dt_cadastro"><?= $Page->dt_cadastro->caption() ?></span></td>
        <td data-name="dt_cadastro"<?= $Page->dt_cadastro->cellAttributes() ?>>
<span id="el_planilha_custo_contrato_dt_cadastro">
...
<?php if ($Page->quantidade->Visible) { // quantidade ?>
    <tr id="r_quantidade"<?= $Page->quantidade->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_quantidade"><?= $Page->quantidade->caption() ?></span></td>
...
<?php if ($Page->escala_idescala->Visible) { // escala_idescala ?>
    <tr id="r_escala_idescala"<?= $Page->escala_idescala->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_escala_idescala"><?= $Page->escala_idescala->caption() ?></span></td>
...
<?php if ($Page->periodo_idperiodo->Visible) { // periodo_idperiodo ?>
    <tr id="r_periodo_idperiodo"<?= $Page->periodo_idperiodo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_periodo_idperiodo"><?= $Page->periodo_idperiodo->caption() ?></span></td>
...
<?php if ($Page->tipo_intrajornada_idtipo_intrajornada->Visible) { // tipo_intrajornada_idtipo_intrajornada ?>
    <tr id="r_tipo_intrajornada_idtipo_intrajornada"<?= $Page->tipo_intrajornada_idtipo_intrajornada->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_tipo_intrajornada_idtipo_intrajornada"><?= $Page->tipo_intrajornada_idtipo_intrajornada->caption() ?></span></td>
...
<?php if ($Page->cargo_idcargo->Visible) { // cargo_idcargo ?>
    <tr id="r_cargo_idcargo"<?= $Page->cargo_idcargo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_cargo_idcargo"><?= $Page->cargo_idcargo->caption() ?></span></td>
...
<?php if ($Page->acumulo_funcao->Visible) { // acumulo_funcao ?>
    <tr id="r_acumulo_funcao"<?= $Page->acumulo_funcao->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_acumulo_funcao"><?= $Page->acumulo_funcao->caption() ?></span></td>
...
<?php if ($Page->usuario_idusuario->Visible) { // usuario_idusuario ?>
    <tr id="r_usuario_idusuario"<?= $Page->usuario_idusuario->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_usuario_idusuario"><?= $Page->usuario_idusuario->caption() ?></span></td>
        <td data-name="usuario_idusuario"<?= $Page->usuario_idusuario->cellAttributes() ?>>
<span id="el_planilha_custo_contrato_usuario_idusuario">
...
<?php if ($Page->contrato_idcontrato->Visible) { // contrato_idcontrato ?>
    <tr id="r_contrato_idcontrato"<?= $Page->contrato_idcontrato->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_planilha_custo_contrato_contrato_idcontrato"><?= $Page->contrato_idcontrato->caption() ?></span></td>
